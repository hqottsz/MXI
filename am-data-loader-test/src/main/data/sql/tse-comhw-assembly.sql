...
INSERT INTO eqp_assmbl_bom ( assmbl_db_id, assmbl_cd, assmbl_bom_id, nh_assmbl_db_id, nh_assmbl_cd,nh_assmbl_bom_id,bom_class_db_id, bom_class_cd, pos_ct, assmbl_bom_cd, assmbl_bom_name, mandatory_bool, cfg_slot_status_db_id, cfg_slot_status_cd, rstat_cd )
VALUES( 4650, 'TSE', 1, 4650, 'TSE',0,0, 'SYS', 1, 'SYS-1', 'Tools and Service Equipment', 1, 0, 'ACTV', 0 );
...
INSERT INTO eqp_assmbl_bom ( assmbl_db_id, assmbl_cd, assmbl_bom_id, nh_assmbl_db_id, nh_assmbl_cd,nh_assmbl_bom_id,bom_class_db_id, bom_class_cd, pos_ct, assmbl_bom_cd, assmbl_bom_name, mandatory_bool, cfg_slot_status_db_id, cfg_slot_status_cd, rstat_cd )
VALUES( 4650, 'COMHW', 1, 4650, 'COMHW',0,0, 'SYS', 1, 'SYS-1', 'Tools and Service Equipment', 1, 0, 'ACTV', 0 );
