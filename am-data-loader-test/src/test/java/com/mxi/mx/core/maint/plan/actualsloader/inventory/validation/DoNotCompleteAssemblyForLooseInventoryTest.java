...
public class DoNotCompleteAssemblyForLooseInventoryTest extends ActualsLoaderTest {

   private boolean iCompleteAssmblyBool = false;
   ...
   public void testTRKOnTRKonTRKPassesValidation() throws Exception {
      ...
      runALValidateInventory( iCompleteAssmblyBool );
