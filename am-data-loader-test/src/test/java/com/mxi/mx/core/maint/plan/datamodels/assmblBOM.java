...
/**
 * This class is to store data from EQP_ASSMBL_BOM query
 *
 */
public class assmblBOM {
   ...
   String NH_ASSMBL_CD;// nh_assmbl_cd;
   String NH_ASSMBL_BOM_ID;// nh_assmbl_bom_id


   // constructor
   public assmblBOM(String ASSMBLE_CD, String ASSMBL_BOM_CD, String ASSMBL_BOM_NAME,
         String ASSMBL_BOM_ID, String BOM_CLASS_CD, String NH_ASSMBL_DB_ID, String NH_ASSMBL_CD,
         String NH_ASSMBL_BOM_ID) {
      this.ASSMBLE_CD = ASSMBLE_CD;
   ...
   /**
    * Returns the value of the aSSMBLE_CD property.
    *
    * @return the value of the aSSMBLE_CD property
    */
   public String getASSMBLE_CD() {
      return ASSMBLE_CD;
   }


   /**
    * Sets a new value for the aSSMBLE_CD property.
    *
    * @param aASSMBLE_CD
    *           the new value for the aSSMBLE_CD property
    */
   public void setASSMBLE_CD( String aASSMBLE_CD ) {
      ASSMBLE_CD = aASSMBLE_CD;
   }
   ...
   public int hashCode() {
      final int prime = 31;
      int result = 1;
      result = prime * result + ( ( ASSMBLE_CD == null ) ? 0 : ASSMBLE_CD.hashCode() );
   ...
   public boolean equals( Object obj ) {
      ...
      if ( getClass() != obj.getClass() )
         return false;
      assmblBOM other = ( assmblBOM ) obj;
      if ( ASSMBLE_CD == null ) {
         if ( other.ASSMBLE_CD != null )
            return false;
      } else if ( !ASSMBLE_CD.equalsIgnoreCase( other.ASSMBLE_CD ) )
         return false;
