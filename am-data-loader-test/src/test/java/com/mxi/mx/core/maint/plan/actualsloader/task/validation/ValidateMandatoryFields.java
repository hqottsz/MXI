...
public class ValidateMandatoryFields extends ActualsLoaderTest {
    ...
    *
    * <ul>
    * <li>AL-TASK-012 validation failure is found - Task code is mandatory.</li>
    * </ul>
    * </p>
    *
    * @throws Exception
    */
   @Test
   public void test_AL_TASK_012_MandatoryTaskCd() throws Exception {
      ...
      // lMapTask.put( "TASK_CD", "'AL_TASK'" ); // field not provided
      ...
      runValidateTasks();
      checkTaskValidation_WITHWARNING( "AL-TASK-012" );
