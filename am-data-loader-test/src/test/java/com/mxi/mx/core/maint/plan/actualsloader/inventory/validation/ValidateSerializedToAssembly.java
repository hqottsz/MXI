 ...
 * Serial Numbers
 *
 * Note: AML-10438 error validation was removed, positive is still valid.
 *
 * @author Andrew Bruce
 */

public class ValidateSerializedToAssembly extends ActualsLoaderTest {
    ...
    *
    * <ul>
    * <li>Serialized aircraft sub inventory loaded against aircraft assembly</li>
    * </ul>
    * </p>
    *
    * <p>
    ...
    */
   @Test
   public void test_AML_10438_CorrectAssemblyForSerializedPart() throws Exception {
      ...
      validateAndCheckInventory( "test_AML_10438_CorrectAssemblyForSerializedPart", "PASS" );
   }
