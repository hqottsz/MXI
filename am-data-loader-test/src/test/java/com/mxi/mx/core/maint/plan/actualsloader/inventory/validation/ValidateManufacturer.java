...
public class ValidateManufacturer extends ActualsLoaderTest {
    ...
    *
    * <ul>
    * <li>Error Code: AML-10201</li>
    * <li>SUB_INVENTORY field MANUFACT_CD does not exist in Maintenix Baseline.</li>
    * </ul>
    * </p>
    *
    * @throws Exception
    ...
    */
   @Test
   public void test_AML_10201_UnknownManufCd_Sub() throws Exception {
      ...
      lMapInventorySub.put( "MANUFACT_CD", "'X111X'" ); // value not known in Mx
      ...
      validateAndCheckInventory( "test_AML_10201_UnknownManufCd_Sub", "AML-10201" );
   }
    ...
    *
    * <ul>
    * <li>Error Code: AML-10205</li>
    * <li>INVENTORY field MANUFACT_CD does not exist in Maintenix Baseline.</li>
    * </ul>
    * </p>
    *
    * @throws Exception
    ...
    */
   @Test
   public void test_AML_10205_UnknownManufCd() throws Exception {

      // create task map
      Map<String, String> lMapInventory = new LinkedHashMap<String, String>();

      lMapInventory.put( "SERIAL_NO_OEM", "'TRK-10201'" );
      lMapInventory.put( "PART_NO_OEM", "'A0000005'" );
      lMapInventory.put( "INV_CLASS_CD", "'TRK'" );
      lMapInventory.put( "MANUFACT_CD", "'VWXYZ'" ); // unknown value in baseline
      lMapInventory.put( "LOC_CD", "'OPS'" );
      lMapInventory.put( "INV_COND_CD", "'RFI'" );
      lMapInventory.put( "MANUFACT_DT", "to_date('01/01/2015','mm/dd/yyyy')" );
      lMapInventory.put( "ASSMBL_CD", "'ACFT_CD1'" );
      ...
      // call inventory validation and check result against expectation
      validateAndCheckInventory( "test_AML_10205_UnknownManufCd", "AML-10205" );
   }
   ...
   @Ignore
   @Test
   public void test_TBD_10202_MissingManufacturerCd() throws Exception {

      // create task map
      Map<String, String> lMapInventory = new LinkedHashMap<String, String>();

      lMapInventory.put( "SERIAL_NO_OEM", "'ACFT-SN'" );
      lMapInventory.put( "PART_NO_OEM", "'ACFT_ASSY_PNX'" );
      lMapInventory.put( "INV_CLASS_CD", "'ACFT'" );

      // lMapInventory.put( "MANUFACT_CD", "'10001'" ); // not provided when there are multiple
      // part numbers
      lMapInventory.put( "LOC_CD", "'OPS'" );
      ...
      // call inventory validation and check result against expectation
      validateAndCheckInventory( "test_TBD_10202_MissingManufacturerCd", "TBD-10202" );
   }
}
