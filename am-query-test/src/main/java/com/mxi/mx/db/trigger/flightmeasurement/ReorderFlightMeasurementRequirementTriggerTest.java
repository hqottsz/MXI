...
public class ReorderFlightMeasurementRequirementTriggerTest implements MxAfterTrigger<UUID> {
   ...
   /**
    *
    * This Test will reorder the measurements to check if the trigger will be fired in this event.
    *
    ...
    */
   @Test
   public void testReorderFlightMeasurementRequirementTrigger()
      ...
      triggerCalled = false;
      // Reorders Measurements for the Test
      assemblyBean.reorderMeasurements( ASSEMBLY_KEY, dataTypeCodeList );
