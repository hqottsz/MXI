...
/**
 * This class tests the Assign Flight Measurement Requirement Modified Triggers
 *
 */
@RunWith( BlockJUnit4ClassRunner.class )
public class AssignFlightMeasurementRequirementTriggerTest implements MxAfterTrigger<UUID> {
   ...
   /**
    *
    * This method tests the Assign FlightMeasurementRequirement Trigger.
    *
    ...
    */
   @Test
   public void testAssignFlightMeasurementRequirementTrigger()
      ...
      // Assigns Measurement for the Test
