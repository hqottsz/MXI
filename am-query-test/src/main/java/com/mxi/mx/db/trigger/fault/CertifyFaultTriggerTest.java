...
/**
 * This class tests Certify Fault Modified Trigger
 *
 */
@RunWith( BlockJUnit4ClassRunner.class )
public class CertifyFaultTriggerTest implements MxAfterTrigger<UUID> {

   private static final String AUTHORIZING_HR_KEY = "4650:789";
   private static final String FAULT_ID = "00000000000000000000000000000102";
   ...
   /**
    * Tests the MX_CF_CERTIFY trigger
    *
    ...
    */
   @Test
   public void testCertifyFaultTrigger()
      ...
      faultBean.findByPrimaryKey( faultKey );
      faultBean.setSessionContext( sessionContextFake );
      faultBean.certify( faultKey, humanResourceKey );
