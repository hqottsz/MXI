...
/**
 * This class tests Issue Purchase order Trigger
 *
 */
@RunWith( BlockJUnit4ClassRunner.class )
public class IssuePurchaseOrderTriggerTest implements MxAfterTrigger<UUID> {
   ...
   public void testIssuePurchaseOrderTrigger()
      ...
      purchaseOrderBean.issue( purchaseOrderKey, note, humanResourceKey );
