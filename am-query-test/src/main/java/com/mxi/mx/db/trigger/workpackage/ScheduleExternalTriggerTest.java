...
public class ScheduleExternalTriggerTest implements MxBeforeAndAfterTrigger<TaskKey> {
    ...
    */
   @Override
   public void before( TaskKey aPk ) throws TriggerException {
    ...
    */
   @Override
   public void after( TaskKey aPk ) throws TriggerException {
