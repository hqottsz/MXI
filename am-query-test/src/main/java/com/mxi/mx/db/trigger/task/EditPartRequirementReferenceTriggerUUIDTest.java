...
public class EditPartRequirementReferenceTriggerUUIDTest implements MxBeforeAndAfterTrigger<UUID> {
   ...
   /**
    * This method gets called when the after trigger logic is invoked
    */
   @Override
   public void after( UUID partRequirementId ) throws TriggerException {
      afterTriggerCalled = true;
   }


   /**
    * This method gets called when the before trigger logic is invoked
    */
   @Override
   public void before( UUID aPartRequirementId ) throws TriggerException {
