...
public final class GetInvoiceLineTaxesTest {
   ...
   public static void loadData() {
      DataLoaders.load( sDatabaseConnectionRule.getConnection(), GetInvoiceLineTaxesTest.class );
   }
   ...
   /**
    * Test the case where Invoices-InvoiceLines-Taxes are not in date range.
    *
    * <ol>
    * <li>Query for all Taxes in date range.</li>
    ...
    */
   @Test
   public void testInvoiceLineTaxesBeforeDate() throws Exception {
   ...
   /**
    * Test the case where InvoiceLines-Taxes for Invoices in the date range are retrieved.
    *
    * <ol>
    * <li>Query for all Taxes in date range.</li>
    * <li>Verify that the results are as expected.</li>
    ...
    */
   @Test
   public void testInvoiceLineTaxesRetrieval() throws Exception {
   ...
   private void testRow( String aPoInvoiceDbId, String aPoInvoiceId, String aPoInvoiceLineId,
         String aTaxId, String aTaxTypeCd ) {
