...
public final class GetOrderLineTaxesTest {
   ...
   public static void loadData() {
      DataLoaders.load( sDatabaseConnectionRule.getConnection(), GetOrderLineTaxesTest.class );
   }
   ...
   /**
    * Test the case where POs-POLines-Taxes are not in date range.
    *
    * <ol>
    ...
    */
   @Test
   public void testLineTaxesBeforeDate() throws Exception {
   ...
   /**
    * Test the case where POLines-Taxes for POs in the date range are retrieved.
    *
    * <ol>
    * <li>Query for all Taxes in date range.</li>
    * <li>Verify that the resuts are as expected.</li>
    ...
    */
   @Test
   public void testLineTaxesRetrieval() throws Exception {
