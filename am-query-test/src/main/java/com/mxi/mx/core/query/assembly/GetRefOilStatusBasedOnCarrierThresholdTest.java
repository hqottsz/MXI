...
/**
 * This class runs a unit test on the GetRefOilStatusBasedOnCarrierThreshold query file.
 *
 * @author krangaswamy
 */

@RunWith( BlockJUnit4ClassRunner.class )
public final class GetRefOilStatusBasedOnCarrierThresholdTest {
   ...
   public static void loadData() {
      DataLoaders.load( sDatabaseConnectionRule.getConnection(),
            GetRefOilStatusBasedOnCarrierThresholdTest.class );
   }
   ...
   /**
    * Execute GetRefOilStatusBasedOnCarrierThreshold.qrx
    */
   @Test
   public void testGetRefOilStatusBasedOnCarrierThreshold() {

      DataSetArgument lArgs = new DataSetArgument();

      // Parameters required by the query.
      lArgs.add( "aCarrierDbId", "4650" );
      lArgs.add( "aCarrierId", "369038" );
      lArgs.add( "aAssmblDbId", "4650" );
      lArgs.add( "aAssmblCd", "CV" );
