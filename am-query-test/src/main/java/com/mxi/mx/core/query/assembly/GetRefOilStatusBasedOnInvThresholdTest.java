...
/**
 * This class runs a unit test on the GetRefOilStatusBasedOnInvThreshold query file.
 *
 * @author krangaswamy
 */

@RunWith( BlockJUnit4ClassRunner.class )
public final class GetRefOilStatusBasedOnInvThresholdTest {
   ...
   public static void loadData() {
      DataLoaders.load( sDatabaseConnectionRule.getConnection(),
            GetRefOilStatusBasedOnInvThresholdTest.class );
   }
   ...
   /**
    * Execute GetRefOilStatusBasedOnInvThreshold.qrx
    */
   @Test
   public void testGetRefOilStatusBasedOnInvThreshold() {

      DataSetArgument lArgs = new DataSetArgument();

      // Parameters required by the query.
      lArgs.add( "aInvNoDbId", "4650" );
      lArgs.add( "aInvNoId", "369038" );
