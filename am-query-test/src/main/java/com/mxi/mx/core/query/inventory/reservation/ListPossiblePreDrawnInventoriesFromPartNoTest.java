...
/**
 * This class performs unit testing for listPossiblePreDrawnInventoriesFromPartNo.
 *
 */
@RunWith( BlockJUnit4ClassRunner.class )
public class ListPossiblePreDrawnInventoriesFromPartNoTest {
   ...
   /**
    * Tests that query returns no data if inventory is not located under same supply location
    *
    * @throws Exception
    *            unknown exception is thrown.
    */
   ...
   private void execute() {
      ...
      lArgs.add( iPartNo, "aPartNoDbId", "aPartNoId" );
      lArgs.add( iSupplyLocation, "aLocationDbId", "aLocationId" );

      // execute query
      iDs = QueryExecutor.executeQuery( iDatabaseConnectionRule.getConnection(),
            "com.mxi.mx.core.query.inventory.reservation.listPossiblePreDrawnInventoriesFromPartNo",
            lArgs );
   ...
   public void loadData() throws Exception {
      ...
      iPartNo = new PartNoBuilder().withDefaultPartGroup().withInventoryClass( RefInvClassKey.SER )
