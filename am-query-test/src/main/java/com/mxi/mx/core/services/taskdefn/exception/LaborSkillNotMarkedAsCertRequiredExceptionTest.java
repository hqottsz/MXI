...
/**
 * Tests the behaviour of the LaborSkillNotMarkedAsCertRequiredExceptionTest.
 */
@RunWith( BlockJUnit4ClassRunner.class )
public final class LaborSkillNotMarkedAsCertRequiredExceptionTest {
   ...
   /**
    * Ensure the validator throws a LaborSkillNotMarkedAsCertRequiredException when the labor skill
   ...
   public void testLaborSkillNotMarkedAsInspRequiredException() throws MxException {
      ...
      new LabourRequirementBuilder( lTaskTask, RefLabourSkillKey.PILOT ).build();
      ...
      try {
         LaborSkillNotMarkedAsCertRequiredException.validate( lTaskTask, lStepSkills );

         fail( "Expected LaborSkillNotMarkedAsCertRequiredException but it was not thrown." );

      } catch ( LaborSkillNotMarkedAsCertRequiredException e ) {
         ;
      }
   }
