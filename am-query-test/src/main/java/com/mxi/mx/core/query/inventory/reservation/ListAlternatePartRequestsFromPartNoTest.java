...
public final class ListAlternatePartRequestsFromPartNoTest {
   ...
   public void testQueryScenario() throws Exception {
      runTestScenario( new ScenarioInvalidStatusReq(), ScenarioInvalidStatusReq.KEY_PART_NO,
   ...
   public void testQueryScenarioHistoricReq() throws Exception {
      runTestScenario( new ScenarioHistoricReq(), ScenarioHistoricReq.KEY_PART_NO,
   ...
   public void testQueryScenarioHistoricTask() throws Exception {
      runTestScenario( new ScenarioHistoricTask(), ScenarioHistoricTask.KEY_PART_NO,
   ...
   public void testQueryScenarioInvPredrawn() throws Exception {
      runTestScenario( new ScenarioInvPredrawn(), ScenarioInvPredrawn.KEY_PART_NO,
   ...
   public void testQueryScenarioInvPredrBin() throws Exception {
      runTestScenario( new ScenarioInvPredrBin(), ScenarioInvPredrBin.KEY_PART_NO,
   ...
   public void testQueryScenarioLocalStockReq() throws Exception {
      runTestScenario( new ScenarioLocalStockReq(), ScenarioLocalStockReq.KEY_PART_NO,
   ...
   public void testQueryScenarioLockedReq() throws Exception {
      runTestScenario( new ScenarioLockedReq(), ScenarioLockedReq.KEY_PART_NO,
   ...
   public void testQueryScenarioNonScheduledReq() throws Exception {
      runTestScenario( new ScenarioNonScheduledReq(), ScenarioNonScheduledReq.KEY_PART_NO,
   ...
   public void testQueryScenarioNullInvReq() throws Exception {
      runTestScenario( new ScenarioNullInvReq(), ScenarioNullInvReq.KEY_PART_NO,
   ...
   public void testQueryScenarioNullTaskReq() throws Exception {
      runTestScenario( new ScenarioNullTaskReq(), ScenarioNullTaskReq.KEY_PART_NO,
   ...
   public void testQueryScenarioQuarNonRFIReq() throws Exception {
      runTestScenario( new ScenarioQuarNonRFIReq(), ScenarioQuarNonRFIReq.KEY_PART_NO,
   ...
   public void testQueryScenarioQuarNullInvReq() throws Exception {
      runTestScenario( new ScenarioQuarNullInvReq(), ScenarioQuarNullInvReq.KEY_PART_NO,
   ...
   public void testQueryScenarioQuarRFIInvReq() throws Exception {
      runTestScenario( new ScenarioQuarRFIInvReq(), ScenarioQuarRFIInvReq.KEY_PART_NO,
   ...
   public void testQueryScenarioRemoteReqNonStock() throws Exception {
      runTestScenario( new ScenarioRemoteReqNonStock(), ScenarioRemoteReqNonStock.KEY_PART_NO,
   ...
   public void testQueryScenarioRemoteReqStock() throws Exception {
      runTestScenario( new ScenarioRemoteReqStock(), ScenarioRemoteReqStock.KEY_PART_NO,
   ...
   public void testQueryStandardScenario() throws Exception {
      runTestScenario( new StandardScenario(), StandardScenario.KEY_PART_NO,
   ...
   public void testQueryScenarioOnOrderReq() throws Exception {
      runTestScenario( new ScenarioOnOrderReq(), ScenarioOnOrderReq.KEY_PART_NO,
   ...
   public void testQueryScenarioPOREQStatusReq() throws Exception {
      runTestScenario( new ScenarioPOREQStatusReq(), ScenarioPOREQStatusReq.KEY_PART_NO,
   ...
   public void testQueryScenarioIssuedReq() throws Exception {
      runTestScenario( new ScenarioIssuedReq(), ScenarioIssuedReq.KEY_PART_NO,
    ...
    *            DOCUMENT_ME
    */
   protected void runTestScenario( StandardScenario aScenario, PartNoKey aPartNo,
         LocationKey aLocation ) throws Exception {
      try {
         aScenario.setup();
         aScenario.validate( execute( aPartNo, aLocation ) );
      } finally {
         aScenario.tearDown();
      }
   }
   ...
   private DataSet execute( PartNoKey aPartNo, LocationKey aLocation ) {
      ...
      DataSet lDs = QueryExecutor.executeQuery( sDatabaseConnectionRule.getConnection(),
            "com.mxi.mx.core.query.inventory.reservation.listAlternatePartRequestsFromPartNo",
            lArgs );
