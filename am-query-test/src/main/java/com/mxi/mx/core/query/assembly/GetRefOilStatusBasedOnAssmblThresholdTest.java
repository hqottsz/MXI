...
/**
 * This class runs a unit test on the GetRefOilStatusBasedOnAssmblThreshold query file.
 *
 * @author krangaswamy
 */

@RunWith( BlockJUnit4ClassRunner.class )
public final class GetRefOilStatusBasedOnAssmblThresholdTest {
   ...
   public static void loadData() {
      DataLoaders.load( sDatabaseConnectionRule.getConnection(),
            GetRefOilStatusBasedOnAssmblThresholdTest.class );
   }
   ...
   /**
    * Execute GetRefOilStatusBasedOnAssmblThreshold.qrx
    */
   @Test
   public void testGetRefOilStatusBasedOnAssmblThreshold() {

      DataSetArgument lArgs = new DataSetArgument();

      // Parameters required by the query.
      lArgs.add( "aAssmblDbId", "4650" );
      lArgs.add( "aAssmblCd", "TEST" );
