...
public final class GetInvoiceLinePurchaseOrdersTest {
   ...
   public static void loadData() {
      DataLoaders.load( sDatabaseConnectionRule.getConnection(),
            GetInvoiceLinePurchaseOrdersTest.class );
   }
   ...
   /**
    * Test the case where Invoices-InvoiceLines-POs are not in date range.
    *
    * <ol>
    * <li>Query for all POs in date range.</li>
    ...
    */
   @Test
   public void testInvoiceLinePOBeforeDate() throws Exception {
   ...
   /**
    * Test the case where InvoiceLines-POs for Invoices in the date range are retrieved.
    *
    * <ol>
    * <li>Query for all POs in date range.</li>
    * <li>Verify that the results are as expected.</li>
    ...
    */
   @Test
   public void testInvoiceLinePurchaseOrdersRetrieval() throws Exception {
   ...
   private void testRow( String aPoInvoiceDbId, String aPoInvoiceId, String aPoInvoiceLineId,
         String PONumber, String POLineNumber ) {
      ...
      MxAssert.assertEquals( PONumber, iDataSet.getString( "po_number" ) );
      MxAssert.assertEquals( POLineNumber, iDataSet.getString( "po_line_number" ) );
   }
}
