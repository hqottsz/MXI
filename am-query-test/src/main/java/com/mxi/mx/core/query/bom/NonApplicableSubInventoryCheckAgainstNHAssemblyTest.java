...
/**
 * This class tests the NonApplicableSubInventoryCheckAgainstNHAssembly query.
 */
@RunWith( BlockJUnit4ClassRunner.class )
public final class NonApplicableSubInventoryCheckAgainstNHAssemblyTest {
    ...
    * inside sub-inventory part range and inside part group applicability range (execute query)
    *
    * Then the query returns 0 rows (meaning there is no inapplicability)
    */
   @Test
   public void testWhenEngineModifiedCodeInSubInventoryPartAndPartGroupApplicabilityRange() {
      // Given
    ...
    *
    * Then the query returns 2 rows: 1 row with inapplicability between the child and 1 with
    * inapplicability between grand-child and the engine
    */
   @Test
   public void
    ...
    *
    * When the aircraft inventory's applicability code is modified such that the modified code falls
    * inside aircraft TRK sub-inventory part range and inside part group applicability range
    * (execute query)
    *
    * Then the query returns 0 rows (meaning there is no inapplicability)
    */
   @Test
   public void testWhenAircraftModifiedCodeInSubInventoryPartAndPartGroupApplicabilityRange() {
      // Given
      InventoryKey lAircraftKey = createAircraftInventory( APPL_CODE_A05 );
      ...
      // When
      String lModifiedApplicabilityCode = "A02";
      execute( lAircraftKey, lModifiedApplicabilityCode );
   ...
   public void testWhenLooseEngineModifiedCodeInPartGroupApplicabilityRangeAndInPartRange() {
      ...
      // When
      String lModifiedApplicabilityCode = "E07";
