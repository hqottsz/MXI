...
/**
 * This test case is used to test GetOrgVendorOrderTypesForUpdateStatusJob.qrx
 *
 * This query is for getting all organization-vendor order type approvals whose status is approved
 ...
 */
public class GetOrgVendorOrderTypesForUpdateStatusJobTest {
   ...
   public void loadData() {
      XmlLoader.load( iConnection.getConnection(),
            GetOrgVendorOrderTypesForUpdateStatusJobTest.class,
            "GetOrgVendorOrderTypesForUpdateStatusJobTest.xml" );
   }


   @Test
   public void testGetOrgVendorOrderTypesForUpdateStatusJob() {

      QuerySet lQs = QuerySetFactory.getInstance().executeQuery(
            "com.mxi.mx.core.query.vendor.GetOrgVendorOrderTypesForUpdateStatusJob" );
