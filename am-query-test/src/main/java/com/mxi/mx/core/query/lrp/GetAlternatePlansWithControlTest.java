...
public final class GetAlternatePlansWithControlTest {
   ...
   public static void loadData() {
      DataLoaders.load( sDatabaseConnectionRule.getConnection(),
            GetAlternatePlansWithControlTest.class );
   }
    ...
    */
   @Test
   public void testAlternatePlansWithControl() {
