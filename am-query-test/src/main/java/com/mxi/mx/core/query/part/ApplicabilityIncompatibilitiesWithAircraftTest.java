...
/**
 * This class tests the ApplicabilityIncompatibilitiesWithAircraft query.
 */
@RunWith( BlockJUnit4ClassRunner.class )
public class ApplicabilityIncompatibilitiesWithAircraftTest {
   ...
   public void
      ...
      // applicability range
      assertEquals( lAircraftKey.toString(), iResultDs.getString( "ass_inv_key" ) );
      assertEquals( APPL_CODE_1, iResultDs.getString( "appl_eff_cd" ) );
    ...
    * When attempting to to reserve,issue,attach component to the engine (execute query)
    *
    * Then the query returns 2 rows with inapplicability between the aircraft and the loose TRK part
    * applicability range and inapplicability between the engine code and the loose TRK part group
    * range
    */
   @Test
   public void
      ...
      assertEquals( lPartGroup,
            iResultDs.getKey( PartGroupKey.class, "bom_part_db_id", "bom_part_id" ) );
      assertEquals( APPL_RANGE_CONTAINING_CODE_6, iResultDs.getString( "part_appl_eff_ldesc" ) );
      assertEquals( PART_NOT_APPLICABLE, iResultDs.getBoolean( "part_applicable_bool" ) );
      assertEquals( lPartNo, iResultDs.getKey( PartNoKey.class, "part_no_db_id", "part_no_id" ) );
   ...
   @Test
   public void
         testWhenAircraftHasNoApplicabiltiyCodeAndEngineCodeNotInPartRangButInPartGroupRangeeOfEngineTRKGettingInstalled() {
    ...
    * part group applicability range
    */
   @Test
   public void
         testWhenLooseEngineCodeNotInPartAndPartGroupApplicabilityRangeOfEngineTRKGettingInstalled() {
