...
public final class GetServiceChecksTest {
   ...
   public static void loadData() {
      DataLoaders.load( sDatabaseConnectionRule.getConnection(), GetServiceChecksTest.class );
   }
   ...
   private static final GregorianCalendar DUE_DATE1 = new GregorianCalendar( 2012, 4, 15, 1, 1 );

   private static final GregorianCalendar DUE_DATE4 = new GregorianCalendar( 2012, 4, 15, 1, 4 );
   ...
   public void testAircraft01_Basic() throws Exception {
      ...
      testRow( ACTUAL_SRVC_CHK_1, "BARCODE1", "TASK_NAME1", SRVC_CHK_DEFN_1, "SRVC_CHK_CD1",
            "SRVC_CHK_NAME1", "AIRCRAFT_NAME1", DUE_DATE1.getTime(), 0.0, null, WP_1, "WP_NAME1",
            SCHED_START_DATE1.getTime(), SCHED_END_DATE1.getTime(), LOCATION_1, "LOCATION_CD1",
            "LOCATION_NAME1", AIRPORT_1, "AIRPORT_CD1", "AIRPORT_NAME1", false );
   ...
   public void testAircraft02_PreventLPA() throws Exception {
      ...
      assertTrue( iDataSet.getBoolean( "is_pinned" ) );
      ...
      assertFalse( iDataSet.getBoolean( "is_pinned" ) );
   }
   ...
   public void testAircraft03_NotInFleet() throws Exception {
      ...
      lLpaFleet.setServiceBlockDefinition( SRVC_CHK_DEFN_3 );
      lLpaFleet.insert();
    ...
    *
    * <p>
    * ACTUAL_SRVC_CHK_4 is based on SRVC_CHK_4, assigned to WP_4, for AIRCRAFT_4, not LRP, plan by
    * 15-MAY-2012 01:00, status is ACTV, not historic.
    * </p>
    *
    * <p>
    * WP_4 is not historic, has class CHECK, not prevented from LPA, not for heavy maintenance, not
    * scheduled.
    * </p>
    *
    * <p>
   ...
   public void testAircraft04_WPNotScheduled() throws Exception {
      ...
      testRow( ACTUAL_SRVC_CHK_4, "BARCODE4", "TASK_NAME4", SRVC_CHK_DEFN_4, "SRVC_CHK_CD4",
            "SRVC_CHK_NAME4", "AIRCRAFT_NAME4", DUE_DATE4.getTime(), 0.0, null, WP_4, "WP_NAME4",
    ...
    *
    * <p>
    * FLEET_E has SRVC_CHK_DEFN_5.
    * </p>
    *
    * <p>
    * SRVC_CHK_DEFN_5 has revision SRVC_CHK_5.
    * </p>
    *
    * <p>
    * SRVC_CHK_5 is ACTV.
    ...
    *
    * <p>
    * ACTUAL_SRVC_CHK_5 is based on SRVC_CHK_5, assigned to WP_5, for AIRCRAFT_5, is LRP, plan by
    * 15-MAY-2012 01:05, status is ACTV, not historic.
    * </p>
    *
    * <p>
    * WP_5 is not historic, has class CHECK, is not prevented from LPA, not for heavy maintenance,
    * scheduled for LOCATION_5.
    * </p>
    *
    * <p>
    * LOCATION_5 under supply location AIRPORT_5.
    * </p>
    *
    * @throws Exception
    */
   ...
   private void testRow( TaskKey aTask, String aBarcode, String aTaskName, TaskDefnKey aBlockKey,
         String aBlockCode, String aBlockName, String aAircraftName, Date aDueDate,
         double aDuration, Date aTaskPlanYieldDate, TaskKey aWPTaskKey, String aWPName,
         Date aWPScheduledStartDate, Date aWPScheduledEndDate, LocationKey aWPLocation,
         String aWPLocationCode, String aWPLocationName, LocationKey aAirport, String aAirportCode,
         String aAirportName, boolean aIsPinned ) {
      ...
      MxAssert.assertEquals( "due_date", aDueDate, iDataSet.getDate( "due_date" ), 0 );
      MxAssert.assertEquals( "duration", aDuration, iDataSet.getDouble( "duration" ) );
      MxAssert.assertEquals( "task_plan_yield_date", aTaskPlanYieldDate,
            iDataSet.getDate( "task_plan_yield_date" ) );
      ...
      MxAssert.assertEquals( aIsPinned, iDataSet.getBoolean( "is_pinned" ) );
   }
}
