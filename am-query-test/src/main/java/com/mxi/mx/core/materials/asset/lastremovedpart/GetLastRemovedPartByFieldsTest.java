...
package com.mxi.mx.core.materials.asset.lastremovedpart;
...
public class GetLastRemovedPartByFieldsTest {
   ...
   public static void loadData() {
      XmlLoader.load( sConnection.getConnection(), GetLastRemovedPartByFieldsTest.class,
            "GetLastRemovedPartByFieldsTest.xml" );
   }


   @Test
   public void testGetLastRemovedPartByFields() {
      // Execute the query
   ...
   @Test
   public void testInvalidLastRemovedPartByFields() {
      // Execute the query
   ...
   private QuerySet execute( String aTaskId, String aPartGroupId, String aPositionId ) {
      ...
      return iQao.executeQuery(
            "com.mxi.mx.core.materials.asset.lastremovedpart.dao.query.GetLastRemovedPartByFields",
            lArgs );
   }
