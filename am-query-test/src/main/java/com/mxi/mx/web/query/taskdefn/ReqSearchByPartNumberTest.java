...
/**
 * Query test for the ReqSearchByPartNumber Query
 *
 * @author sdeshmukh
 */

@RunWith( BlockJUnit4ClassRunner.class )
public final class ReqSearchByPartNumberTest {
   ...
   public static void loadData() {
      DataLoaders.load( sDatabaseConnectionRule.getConnection(), ReqSearchByPartNumberTest.class );
   }
   ...
   /**
    * Test the case where TaskDefn(REQ) are retrieved for an Part Number.
    *
    * <ol>
    * <li>Query for all TaskDefn(REQ) related to Part Number.</li>
    ...
    */
   @Test
   public void testNoReqSearchByPartNumber() throws Exception {
      execute( "1234-1", 100 );
   ...
   /**
    * Test the case where TaskDefn(REQ) are not there for an Part Number.
    *
    * <ol>
    * <li>Query for all TaskDefn(REQ) related to Part Number.</li>
    * <li>Verify that the resuts are as expected.</li>
    ...
    */
   @Test
   public void testReqSearchByPartNumber() throws Exception {
      execute( "1234-2", 1 );
      assertEquals( 1, iDataSet.getRowCount() );

      iDataSet.next();
      testRow( "4650:15910", "80-001-REQ3 (Query Test For Req)", "REQ", "ACTV", "1", "null",
            "MRB" );
   }
