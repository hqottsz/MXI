...
/**
 * This class performs unit testing on the query file EditWorkCaptureMeasurements.qrx.
 *
 */
@RunWith( BlockJUnit4ClassRunner.class )
public class EditWorkCaptureMeasurementsTest {

   private static final String TEST_NA_NOTE_FOR_MEASUREMENT = "NA Note for the measurement";
   ...
   private SchedLabourKey iLabourKey = new SchedLabourKey( 4650, 200 );
   ...
   public void itReturnsCorrectMeasurmentsOrderOfAJobCard() {
      ...
      lDataSetArgument.add( "aSchedDbId", lJobCard.getDbId() );
      lDataSetArgument.add( "aSchedId", lJobCard.getId() );
      lDataSetArgument.add( "aLabourDbId", iLabourKey.getDbId() );
      lDataSetArgument.add( "aLabourId", iLabourKey.getId() );
   ...
   public void itReturnsNaNoteOfMeasurement() {
         ...
         public void configure( JobCard aJobCard ) {
            ...
            aJobCard.addMeasurementConfig( new DomainConfiguration<Measurement>() {
               ...
               public void configure( Measurement aMeasurement ) {
                  ...
                  aMeasurement.setInventory( lAircraft );
                  aMeasurement.setDataType( lMeasurementDefinition2 );
                  aMeasurement.setNaNote( null ); // no NA note set for the measurement
               }
      ...
      // Expected NA note:
      Assert.assertEquals( "Measurement1 should not have an empty note.",
