...
/**
 * This class performs unit testing on the ClaimPartLines query file with the same package and name.
 *
 * @author akash
 */

@RunWith( BlockJUnit4ClassRunner.class )
public final class ClaimPartLinesTest {
   ...
   public static void loadData() {
      DataLoaders.load( sDatabaseConnectionRule.getConnection(), ClaimPartLinesTest.class );
   }
   ...
   /**
    * Test Results of ClaimPartLines query
    *
    * @throws Exception
    *            if an error occurs.
    */
   @Test
   public void testClaimPartLines() throws Exception {
      ...
      MxAssert.assertEquals( "4650:1:1", iDataSet.getString( "claim_part_line_key" ) );
      ...
      MxAssert.assertEquals( "SN186", iDataSet.getString( "serial_no_oem" ) );
      MxAssert.assertEquals( "Test Task", iDataSet.getString( "event_sdesc" ) );
      MxAssert.assertEquals( "Test Shipment", iDataSet.getString( "shipment_id" ) );
