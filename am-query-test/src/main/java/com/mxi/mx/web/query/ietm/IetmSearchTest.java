...
/**
 * This class performs unit testing on the IetmSearch query file.
 *
 * @author akash
 */

@RunWith( BlockJUnit4ClassRunner.class )
public final class IetmSearchTest {
   ...
   public static void loadData() {
      DataLoaders.load( sDatabaseConnectionRule.getConnection(), IetmSearchTest.class );
   }
   ...
   public void testIetmSrchAttach() throws Exception {
      execute( new IetmDefinitionKey( "4650:2010" ), "A Attachment" );
      assertEquals( 1, iDataSet.getRowCount() );

      iDataSet.next();
      testRow( "4650:2010", "AMP (F-2003 Maintenance Manual)", "A Attachment", "TXT",
   ...
   public void testIetmSrchTechRef() throws Exception {
      execute( new IetmDefinitionKey( "4650:2010" ), "A Tech Ref" );
      assertEquals( 1, iDataSet.getRowCount() );

      iDataSet.next();
      testRow( "4650:2010", "AMP (F-2003 Maintenance Manual)", "A Tech Ref", "PDF",
            "this is a long description of Technical Reference",
            "testing topic note of Technical Reference", true );
   }
