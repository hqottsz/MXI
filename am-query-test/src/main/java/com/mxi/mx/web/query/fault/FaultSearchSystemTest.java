...
import com.mxi.mx.web.search.fault.ByAircraftSystem;
import com.mxi.mx.web.search.fault.ByAssemblySystem;
...
public final class FaultSearchSystemTest {
   ...
   /**
    * Tests the query with an invalid Aircraft and System
    *
    * @throws Exception
    *            if an error occurs
    */
   @Test
   public void testInvalidAircraftSystem() throws Exception {

      DataSetArgument lArgs = new DataSetArgument();

      /* Invalid Aircraft and System */

      ByAircraftSystem lTestObject = new ByAircraftSystem();
      lTestObject.addSearchArgs( lArgs, "INVALID AIRCRAFT", "INVALID ASSEMBLY" );
   ...
   /**
    * Tests the query with an invalid assembly and system
    *
    * @throws Exception
    *            if an error occurs
    */
   @Test
   public void testInvalidAssemblySystem() throws Exception {
      DataSetArgument lArgs = new DataSetArgument();

      // assembly invalid and system invalid

      ByAssemblySystem lTestObject = new ByAssemblySystem();
      lTestObject.addSearchArgs( lArgs, "INVALID ASSEMBLY", "INVALID BOM" );
   ...
   /**
    * Tests the search by Aircraft and System query
    *
    * @throws Exception
    *            if an error occurs
    */
   @Test
   public void testSearchByAicraftSystem() throws Exception {
      ...
      ByAircraftSystem lTestObject = new ByAircraftSystem();
      lTestObject.addSearchArgs( lArgs, "123", "MD-2000" );
   ...
   /**
    * Tests the search by Assembly and System query
    *
    * @throws Exception
    *            if an error occurs
    */
   @Test
   public void testSearchByAssemblySystem() throws Exception {
      ...
      ByAssemblySystem lTestObject = new ByAssemblySystem();
      lTestObject.addSearchArgs( lArgs, "F-2000", "MD-2000" );
   ...
   public static void loadData() throws Exception {
      XmlLoader.load( sDatabaseConnectionRule.getConnection(), FaultSearchSystemTest.class,
