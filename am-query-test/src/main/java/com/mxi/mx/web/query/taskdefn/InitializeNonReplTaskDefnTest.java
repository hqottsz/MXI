...
/**
 * This is a test class for testing InitializeNonReplTaskDefn.qrx
 *
 */
public class InitializeNonReplTaskDefnTest {
   ...
   @Test
   public void itReturnsZeroActiveTaskInstanceWhenNoActiveTaskOfTaskDefinitionForAnInventory()
         throws Exception {
      // Arrange
