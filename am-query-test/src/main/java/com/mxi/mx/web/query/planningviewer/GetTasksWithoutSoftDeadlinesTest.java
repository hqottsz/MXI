...
/**
 * This class tests the query com.mxi.mx.web.query.planningviewer.GetTasksWithoutSoftDeadlines.qrx
 *
 * @author hzheng
 */

@RunWith( BlockJUnit4ClassRunner.class )
public final class GetTasksWithoutSoftDeadlinesTest {
   ...
   public static void loadData() {
      DataLoaders.load( sDatabaseConnectionRule.getConnection(),
            GetTasksWithoutSoftDeadlinesTest.class );
   }
   ...
   /**
    * Get tasks without soft deadlines
    *
    * @param aDayCount
   ...
   private QuerySet getTasksWithoutSoftDeadlines( int aDayCount ) {
      ...
      return QuerySetFactory.getInstance().executeQuery(
            "com.mxi.mx.web.query.planningviewer.GetTasksWithoutSoftDeadlines", lArgs );
   }
}
