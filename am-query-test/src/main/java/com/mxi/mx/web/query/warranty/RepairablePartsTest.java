...
/**
 * This class performs unit testing on the RepairableParts query file with the same package and
 * name.
 *
 * @author akash
 */
...
public final class RepairablePartsTest {
   ...
   public static void loadData() {
      DataLoaders.load( sDatabaseConnectionRule.getConnection(), RepairablePartsTest.class );
   }
   ...
   /**
    * Test Results of RepairableParts query
    *
    * @throws Exception
    *            if an error occurs.
    */
   @Test
   public void testRepairableParts() throws Exception {
