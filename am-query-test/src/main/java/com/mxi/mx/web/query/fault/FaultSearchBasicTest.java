...
import com.mxi.mx.web.search.fault.ByAircraftName;
import com.mxi.mx.web.search.fault.ByAssemblyName;
import com.mxi.mx.web.search.fault.ByLogbookNo;
...
public final class FaultSearchBasicTest {
   ...
   /**
    * Tests the query with an invalid Aircraft Name
    *
    * @throws Exception
    *            if an error occurs
    */
   @Test
   public void testInvalidAircraftName() throws Exception {

      DataSetArgument lArgs = new DataSetArgument();

      /* Invalid Aircraft and fault name */

      ByAircraftName lTestObject = new ByAircraftName();
      lTestObject.addSearchArgs( lArgs, "INVALID AIRCRAFT", "INVALID NAME" );
   ...
   /**
    * Tests the query with an invalid Assemly Name
    *
    * @throws Exception
    *            if an error occurs
    */
   @Test
   public void testInvalidAssemblyName() throws Exception {
      DataSetArgument lArgs = new DataSetArgument();

      // Assembly Invalid and Fault Name Invalid
      ByAssemblyName lTestObject = new ByAssemblyName();
      lTestObject.addSearchArgs( lArgs, "INVALID ASSEMBLY", "INVALID NAME" );
   ...
   /**
    * Tests the query with an invalid LogbookNo
    *
    * @throws Exception
    *            if an error occurs
    */
   @Test
   public void testInvalidLogbookNo() throws Exception {
      DataSetArgument lArgs = new DataSetArgument();

      // Aircraft Invalid and Log Reference Invalid

      ByLogbookNo lTestObject = new ByLogbookNo();
      lTestObject.addSearchArgs( lArgs, "INVALID", "INVALID REFERENCE" );
   ...
   /**
    * Tests the search by Aircraft and fault Name query
    *
    * @throws Exception
    *            if an error occurs
    */
   @Test
   public void testSearchByAicraftName() throws Exception {
      ...
      ByAircraftName lTestObject = new ByAircraftName();
      lTestObject.addSearchArgs( lArgs, "123", "Test Fault for Deferral" );
      ...
      testRow( lFaultsDs, new EventKey( "4650:105727" ), "Test Fault for Deferral", "1", "MINOR",
            "CERTIFY", "test reference", null, new TaskKey( "4650:105729" ),
            "Test Fault for Deferral", "NONE", null, "T0000SNU", new TaskKey( "4650:105728" ),
            "Corrective Check - [105727] Test Fault for Deferral", "1", "WO - 105728", null, null,
            null, null, "T0000OXD", new AircraftKey( "4650:65617" ), "Falcon 2000 - 123",
            new InventoryKey( "4650:65617" ), "Falcon 2000 - 123", new AssemblyKey( "4318:F-2000" ),
            "Falcon 2000", "MD-2000", null,
            new SimpleDateFormat( "dd-MMM-yyyy hh:mm" ).parse( "23-JUN-2004 14:39" ),
            new SimpleDateFormat( "dd-MMM-yyyy hh:mm" ).parse( "28-JUN-24 11:50" ),
            new SimpleDateFormat( "dd-MMM-yyyy hh:mm" ).parse( "28-JUN-24 11:50" ), null, null,
            null, null, null, null, new FlightLegId( "6CCEA551E4C744B4ADA655827F317CB7" ), null,
            "1691" );
   }


   /**
    * Tests the search by assembly and fault name query
    *
    * @throws Exception
    *            if an error occurs
    */
   @Test
   public void testSearchByAssemblyName() throws Exception {
      ...
      ByAssemblyName lTestObject = new ByAssemblyName();
      lTestObject.addSearchArgs( lArgs, "F-2000", "Test Fault for Deferral" );
   ...
   /**
    * Tests the search by Logbook no query
    *
    * @throws Exception
    *            if an error occurs
    */
   @Test
   public void testSearchByLogbookNo() throws Exception {

      DataSetArgument lArgs = new DataSetArgument();

      // build the WHERE_CLAUSE for the query
      ByLogbookNo lTestObject = new ByLogbookNo();
      lTestObject.addSearchArgs( lArgs, "123", "test reference" );
   ...
   public static void loadData() throws Exception {
      XmlLoader.load( sDatabaseConnectionRule.getConnection(), FaultSearchBasicTest.class,
