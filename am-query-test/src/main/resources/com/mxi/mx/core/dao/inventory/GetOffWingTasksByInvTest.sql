...
--main inventory AIRCRAFT
insert into inv_inv ( inv_no_db_id, inv_no_id ) values ( 777, 1 );
...
insert into task_task ( task_db_id, task_id, soft_deadline_bool, task_must_remove_db_id, task_must_remove_cd ) values ( 777, 101, 0, 0, 'OFFWING' );

-- off-wing task 2 with soft deadline
insert into task_task ( task_db_id, task_id, soft_deadline_bool, task_must_remove_db_id, task_must_remove_cd ) values ( 777, 102, 1, 0, 'OFFWING' );

--on-wing task 3 with hard deadline
insert into task_task ( task_db_id, task_id, soft_deadline_bool, task_must_remove_db_id, task_must_remove_cd ) values ( 777, 103, 0, 0, 'OFFWING' );

-- off-wing task 4 with hard deadline
insert into task_task ( task_db_id, task_id, soft_deadline_bool, task_must_remove_db_id, task_must_remove_cd ) values ( 777, 104, 0, 0, 'OFFWING' );
...
insert into sched_stask ( sched_db_id, sched_id, task_db_id,  task_id ) values ( 777, 102, 777, 102 );
...
--work order package:
insert into sched_stask ( sched_db_id, sched_id, task_class_db_id,  task_class_cd, main_inv_no_db_id, main_inv_no_id ) values ( 777, 91, 0, 'RO', 777, 1 );

--check work package:
insert into sched_stask ( sched_db_id, sched_id, task_class_db_id,  task_class_cd, main_inv_no_db_id, main_inv_no_id ) values ( 777, 92, 0, 'CHECK', 777, 1 );


insert into evt_event ( event_db_id, event_id, h_event_db_id, h_event_id, hist_bool, event_status_cd ) values ( 777, 101, 777, 92, 0, 'ACTV' );
...
insert into evt_event ( event_db_id, event_id, h_event_db_id, h_event_id, hist_bool, event_status_cd ) values ( 777, 103, 777, 92, 0, 'ACTV' );

-- already under work order
insert into evt_event ( event_db_id, event_id, h_event_db_id, h_event_id, hist_bool, event_status_cd ) values ( 777, 104, 777, 91, 0, 'ACTV' );
