...
/**
 * Run feature tests in isolation for Line Maintenance only to avoid running the whole test suite
 * when working on specific scenarios
 *
 * <pre>
 ...
 *    Given unannotated scenarios
 *     When I add the RunAMLine annotation to scenarios
...
@CucumberOptions( plugin = { "pretty", "html:build/reports/cucumber" }, monochrome = true,
      tags = { "@RunAMLine", "~@Ignore", "~@RequiresMule" } )
public class RunAMLineCucumberTests {
