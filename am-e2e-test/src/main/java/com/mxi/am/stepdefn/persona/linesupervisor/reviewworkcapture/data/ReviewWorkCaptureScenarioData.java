package com.mxi.am.stepdefn.persona.linesupervisor.reviewworkcapture.data;
...
public final class ReviewWorkCaptureScenarioData {
   ...
   public static final String AIRCRAFT_SERIAL_NO = "LT-RCS-3";

   // Fault Data
   public static final String FAILED_SYSTEM_SDESC = "SYS-LT5-1 - Aircraft System 1";
   public static final String FAULT_NAME_REVIEW_WORK_CAPTURE =
         "Review Work Capture-" + UUID.randomUUID().toString();
   ...
   // Work Package Data
   public static final String WORK_PACKAGE_NAME = "RCS-REVIEW WORK CAPTURE";
   ...
   private ReviewWorkCaptureScenarioData() {
   }
}
