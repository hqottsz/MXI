...
public class CreatePurchaseInvoiceNoInvoiceQtyUnitStepDefinitions {
   ...
   public void
         theExternalSystemCompletesThreeWayMatchingAndSendsAnVALIDInboundCreatePurchaseInvoiceMessageWithoutInvoiceQuantityUnitInformation(
   ...
   public void
         theExternalSystemCompletesTwoWayMatchingAndSendsAnVALIDInboundCreatePurchaseInvoiceMessageWithoutInvoiceQuantityUnitInformation(
               List<Map<String, String>> aDataTable ) throws Throwable {
   ...
   public void
         anInvoiceWithInvoiceQuantityUnitSetToOrderMiscellaneousLineQuantityUnitIsCreatedAndAPurchaseInvoiceCreatedMessageIsSent(
               List<Map<String, String>> aDataTable ) throws Throwable {
      ...
      for ( int i = 0; i <= lPOInvoiceLines.size() - 2; i++ ) {
         ...
         // Validate Invoice Qty and Invoice Qty Unit
