...
public final class AssignWorkPackageToCrewScenarioData {
   ...
   public static final String WORK_PACKAGE = "WP20986-04";
   public static final String ASSIGNED_TASK = "BM_SCH_TSK4 (BM_SCH_TSK4)";
   ...
   private AssignWorkPackageToCrewScenarioData() {
   }
