 ...
 */
@ScenarioScoped
public class AsbNotificationJmsQueueDriverProvider implements Provider<JmsQueueDriver> {

   private final JmsQueueDriver iJmsQueueDriver;


   /**
    * Creates a new {@linkplain AsbNotificationJmsQueueDriverProvider} object.
    *
    */
   @Inject
   public AsbNotificationJmsQueueDriverProvider(InitialContextFactory aInitialContextFactory,
      ...
      iJmsQueueDriver = aFactory.createInstance( aInitialContextFactory.getIntance(),
            "com.mxi.mx.jms.AsbAdapterNotificationQueue", 30000 );
