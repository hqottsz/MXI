...
VALUES (
  ...
  1,
  4650,
  (SELECT inv_no_id FROM inv_inv WHERE assmbl_cd = 'ACFTENG5' AND inv_class_cd = 'SYS'),
  4650,
  (SELECT inv_no_id FROM inv_inv WHERE serial_no_oem = 'OPER-18603'),
  4650,
  (SELECT inv_no_id FROM inv_inv WHERE serial_no_oem = 'OPER-18603'),
  4650,
  (SELECT inv_no_id FROM inv_inv WHERE serial_no_oem = 'OPER-18603'),
...
VALUES (
  ...
  event_id_seq.currval,
  4650,
  (SELECT evt_event.event_id FROM evt_event WHERE evt_event.event_sdesc = 'FAULT-OPER-18603'),
  0,
  'CORR',
  4650,
  (SELECT inv_no_id FROM inv_inv WHERE assmbl_cd = 'ACFTENG5' AND inv_class_cd = 'SYS'),
...
VALUES (
  ...
  1,
  4650,
  (SELECT evt_event.event_id FROM evt_event WHERE evt_event.event_sdesc = 'CORR-OPER-18603'),
  0,
  'CORRECT',
  1
);