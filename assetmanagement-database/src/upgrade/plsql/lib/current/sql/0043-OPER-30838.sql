...
--changeSet OPER-30838:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet OPER-30838:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
BEGIN
   ...
   FOR lCurInv IN (
      SELECT DISTINCT
         ...
         inv_inv.inv_no_id
      FROM
         TABLE(aittb_inv_assmbl) usage_to_update
...
AS
   ...
   v_ttb_inv_assmbl    IntIntIntIntTABLE := NULL;
