...
--changeSet OPER-13116-SP4:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
   ...
   FOR lrec_EventDead IN lcur_EventDead(al_EventDbId, al_EventId) LOOP
      ...
      ELSIF (lrec_EventDead.domain_type_cd = 'US') THEN
         ...
         ELSE
            ...
            /* get the various usage remaining values */
            lf_UsageRemQt := calculateUsageRemaining(lrec_EventDead.sched_dead_qt, lrec_CurrUsage.tsn_qt, lrec_EventDead.Entry_Prec_Qt);
...
BEGIN
   ...
   FOR lrec_USDeadlines IN lcur_USDeadlines (an_SchedDbId, an_SchedId) LOOP
      ...
      lf_UsageRem := calculateUsageRemaining(lf_SchedDeadQt, lrec_USDeadlines.Tsn_Qt, lrec_USDeadlines.entry_prec_qt);
