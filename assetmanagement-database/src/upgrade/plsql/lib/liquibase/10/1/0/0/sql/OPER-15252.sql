...
-- OPER-15252 Resolve an aircraft duplication issue when multiple started flights are on one aircraft

--changeSet OPER-15252:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet OPER-15252:2 stripComments:false
