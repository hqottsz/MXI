...
--changeSet OPER-5873:1 stripComments:false
...
BEGIN
   ...
   IF ln_SameTaskDefn = 0 THEN
      ...
      WHERE
         ...
         AND NOT
         (
            task_task.task_defn_db_id = prev_task.task_defn_db_id
            AND
         ...
         (
            ...
            WHERE
               ...
               task_task_dep.task_id = prev_task.task_id AND
