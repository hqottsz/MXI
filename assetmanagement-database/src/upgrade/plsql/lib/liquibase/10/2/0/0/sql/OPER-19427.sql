...
-- OPER-19427 Remove trailing spaces in upgrade script in OPER-15252

--changeSet OPER-19427:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
--comment drop the materialized view.
BEGIN
   UTL_MIGR_SCHEMA_PKG.MATERIALIZED_VIEW_DROP('MV_FLEETLIST');
END;
/ 

--changeSet OPER-19427:2 stripComments:false
--comment Create the updated materialized view
