...
--changeSet OPER-9863:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
BEGIN
   ...
   IF(aiv_system_note IS NOT NULL) THEN   
      ...
      vi_system_note := ' [(LegId = '||vi_flight_leg||')] <br> '||aiv_system_note;  
   END IF ;
   ...
   v_step := 80;
   updateFollowingEventTsn(v_ttb_adjusted_usage_delta, v_ttb_inv_assmbl, vi_usage_dt, vi_system_note, aiv_workpackage_system_note, aiv_task_system_note, aiv_fault_system_note);
