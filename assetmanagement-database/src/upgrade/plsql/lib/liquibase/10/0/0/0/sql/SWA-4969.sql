...
--changeSet SWA-4969:1 stripComments:false
...
INSERT INTO
  ...
  SELECT
	'MX_ENGINE_ATTACHED',0,0,0,0, 1, 0, sysdate, 0, sysdate, 0, 'MXI'
  FROM
  	dual
  WHERE
  	NOT EXISTS ( SELECT 1 FROM int_event_config WHERE event_type_cd = 'MX_ENGINE_ATTACHED' );
