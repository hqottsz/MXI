...
--changeSet SWA-4011:1 stripComments:false
...
INSERT INTO 
  ...
  SELECT
	'MX_PART_REQUEST_MESSAGE_V2_2',0,0,0,0, 1, 0, sysdate, 0, sysdate, 0, 'MXI'
  FROM
  	dual
  WHERE
  	NOT EXISTS ( SELECT 1 FROM int_event_config WHERE event_type_cd = 'MX_PART_REQUEST_MESSAGE_V2_2' );