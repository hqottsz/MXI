...
--changeSet OPER-25080-11:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
/********************************************************************************
*
      ...
      WHERE
         ...
         (
            ...
            (
               ...
               WHERE
                  -- context filters
				  -- null represent tasks within the task_fleet_approval is valid for all inventory
                  (vw_h_baseline_task.filter_inv_no_db_id is null or vw_h_baseline_task.filter_inv_no_db_id = aInvNoDbId) AND
                  (vw_h_baseline_task.filter_inv_no_id is null or vw_h_baseline_task.filter_inv_no_id = aInvNoId) AND
                  -- data filters
