...
--changeSet OPER-26624_2:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
/********************************************************************************
*
...
(
   ...
   CURSOR lDeptTask IS
      ...
      WHERE
         ...
         (
            vw_h_baseline_task.filter_inv_no_db_id IS NULL
            OR
            vw_h_baseline_task.filter_inv_no_db_id = aInvNoDbId
         )
         AND
         (
            vw_h_baseline_task.filter_inv_no_id IS NULL
            OR
            vw_h_baseline_task.filter_inv_no_id = aInvNoId
         )
         AND
