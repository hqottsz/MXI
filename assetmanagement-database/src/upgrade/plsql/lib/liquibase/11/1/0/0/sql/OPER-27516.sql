...
--changeSet OPER-27516:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
CREATE OR REPLACE PACKAGE SCHED_STASK_PKG
   ...
   *********************************************************************************/
   ...
   /* This function will return if a non forecasted task instance exists */
...
--changeSet OPER-27516:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet OPER-27516:3 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
/
--changeSet OPER-27516:4 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
