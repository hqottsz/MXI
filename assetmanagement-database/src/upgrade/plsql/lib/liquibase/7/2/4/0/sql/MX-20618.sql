...
--changeSet MX-20618:1 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
-- Drop Foreign Key Constraint 
BEGIN
   UTL_MIGR_SCHEMA_PKG.TABLE_CONSTRAINT_DROP('CLAIM_PART_LINE', 'FK_INVINV_CLAIMPARTLINE');
END;
/

--changeSet MX-20618:2 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
-- Rename column name
BEGIN
   UTL_MIGR_SCHEMA_PKG.TABLE_COLUMN_RENAME('CLAIM_PART_LINE', 'RMV_INV_NO_DB_ID', 'INV_NO_DB_ID');
END;
/

--changeSet MX-20618:3 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.TABLE_COLUMN_RENAME('CLAIM_PART_LINE', 'RMV_INV_NO_ID', 'INV_NO_ID');
END;
/

--changeSet MX-20618:4 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
-- Drop Constraints
BEGIN
   UTL_MIGR_SCHEMA_PKG.TABLE_COLUMN_CONS_CHK_DROP('CLAIM_PART_LINE', 'INV_NO_DB_ID');
END;
/

--changeSet MX-20618:5 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.TABLE_COLUMN_CONS_CHK_DROP('CLAIM_PART_LINE', 'INV_NO_ID');
END;
/

--changeSet MX-20618:6 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
-- Add Check Constraints
BEGIN
  utl_migr_schema_pkg.table_column_modify('
  Alter table CLAIM_PART_LINE modify (
...
--changeSet MX-20618:7 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
 BEGIN
  utl_migr_schema_pkg.table_column_modify('
  Alter table CLAIM_PART_LINE modify (
...
--changeSet MX-20618:8 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet MX-20618:9 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
