...
--changeSet MX-17156:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
utl_migr_schema_pkg.index_create('
Create Index "INVINV_ZIPTASK_FK" ON "ZIP_TASK" ("ASSMBL_INV_NO_DB_ID","ASSMBL_INV_NO_ID") 
');
END;
/

--changeSet MX-17156:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet MX-17156:3 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
/*
...
--changeSet MX-17156:4 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
