...
CREATE OR REPLACE PACKAGE "APPLICATION_OBJECT_PKG" IS
   ...
   FUNCTION getservicepacknumber RETURN VARCHAR2;
   /* Function to get Timestamp */
   FUNCTION gettimestamp RETURN DATE;
   /* Procedure to set the MXI Error Msgid and Message Parms */
   FUNCTION getmxierror RETURN VARCHAR2;
   /* Function to get the current execution mode */
   FUNCTION getexecmode RETURN VARCHAR2;
   /* Function to get the local database's db_type */
   FUNCTION getdbtypecd(an_db_id IN NUMBER) RETURN VARCHAR2;
