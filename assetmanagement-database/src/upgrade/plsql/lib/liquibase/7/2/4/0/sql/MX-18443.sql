...
--changeSet MX-18443:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
/********************************************************************************
*
		   ...
		   WHERE
            ...
            (
               ...
               WHERE
                  ...
                  AND
                  task_task_dep.dep_task_defn_db_id = dep_task_task.task_defn_db_id AND
                  task_task_dep.dep_task_defn_id    = dep_task_task.task_defn_id
                  AND
         	  ...
         	  dep_sched_stask.rstat_cd	= 0
                  ...
                  dep_evt_event.event_id    = dep_sched_stask.sched_id
                  AND
