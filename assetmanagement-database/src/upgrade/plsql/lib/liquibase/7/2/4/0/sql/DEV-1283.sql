...
--changeSet DEV-1283:1 stripComments:false
/**********************************************************
...
--changeSet DEV-1283:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
/**************************************************************************
 * Create new configuration parameter 'ACTION_SEARCH_BROKER
 **************************************************************************/
 BEGIN
       utl_migr_data_pkg.config_parm_insert(
                    'ACTION_SEARCH_BROKER',
                    'SECURED_RESOURCE',
                    'Permission to search brokers.',
                    'USER',
                    'TRUE/FALSE',
                    'FALSE',
                     1,
