...
--changeSet MX-19188:1 stripComments:false
...
SELECT 'false', 'ACTION_UPDATE_ACFT_DEADLINES', 'SECURED_RESOURCE','Permission to request the update of deadlines on an aircraft','USER', 'TRUE/FALSE', 'FALSE', 1,'Supply - Inventory', '6.8.12-SP1',0 
FROM  dual
WHERE NOT EXISTS (SELECT 1 FROM utl_config_parm WHERE parm_name = 'ACTION_UPDATE_ACFT_DEADLINES' );

--changeSet MX-19188:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet MX-19188:3 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
/*
...
--changeSet MX-19188:4 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
