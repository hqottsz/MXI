...
--changeSet MX-18888:1 stripComments:false
-- remove the UPDATE_INV_TREE_DL async action type
DELETE FROM utl_async_action t WHERE t.action_type_cd = 'UPDATE_INV_TREE_DL';

--changeSet MX-18888:2 stripComments:false
DELETE FROM utl_async_action_type t WHERE t.async_action_type_cd = 'UPDATE_INV_TREE_DL';

--changeSet MX-18888:3 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
    UTL_MIGR_SCHEMA_PKG.PROCEDURE_DROP('EVENT_PKG_UPDTDEADLINEFORINV');
END;
/ 

--changeSet MX-18888:4 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet MX-18888:5 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
