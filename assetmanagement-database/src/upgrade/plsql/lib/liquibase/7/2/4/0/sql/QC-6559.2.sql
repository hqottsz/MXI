...
--changeSet QC-6559.2:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet QC-6559.2:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
CREATE OR REPLACE PACKAGE BODY PPC_PKG IS
   ...
   CURSOR lcur_PlanLocationList (
      ...
      FROM
         ppc_plan
         INNER JOIN ppc_loc ON ppc_loc.ppc_db_id = ppc_plan.ppc_db_id AND
                               ppc_loc.ppc_id = ppc_plan.ppc_id
      WHERE
...
BEGIN
   FOR lrec_PlanLocationList IN lcur_PlanLocationList( an_PpcDbId, an_PpcId )
   LOOP
     -- Delete: ppc_hr_lic
     DELETE ppc_hr_lic
     WHERE
       ...
       (
           ...
           FROM
               ppc_hr_lic
               INNER JOIN ppc_hr_shift_plan ON ppc_hr_shift_plan.ppc_hr_shift_db_id = ppc_hr_lic.ppc_hr_shift_db_id AND
                                               ppc_hr_shift_plan.ppc_hr_shift_id    = ppc_hr_lic.ppc_hr_shift_id
           WHERE
               ppc_hr_shift_plan.ppc_loc_db_id = lrec_PlanLocationList.Ppc_Loc_Db_Id AND
               ppc_hr_shift_plan.ppc_loc_id    = lrec_PlanLocationList.Ppc_Loc_Id
       );
     ...
     WHERE
       ...
       (
           ...
           FROM
               ppc_hr_slot
               INNER JOIN ppc_hr_shift_plan ON ppc_hr_shift_plan.ppc_hr_shift_db_id = ppc_hr_slot.ppc_hr_shift_db_id AND
...
BEGIN
   ...
   WHERE
      ( ppc_hr_slot.ppc_hr_slot_db_id, ppc_hr_slot.ppc_hr_slot_id )
      IN
      (  SELECT 
         ...
         FROM
            ppc_wp
            INNER JOIN ppc_activity ON ppc_activity.ppc_wp_db_id = ppc_wp.ppc_wp_db_id AND
                                       ppc_activity.ppc_wp_id    = ppc_wp.ppc_wp_id
            INNER JOIN ppc_labour ON ppc_labour.ppc_task_db_id = ppc_activity.ppc_activity_db_id AND
                                       ppc_labour.ppc_task_id  = ppc_activity.ppc_activity_id
            INNER JOIN ppc_labour_role ON ppc_labour_role.labour_db_id =  ppc_labour.labour_db_id AND
                                          ppc_labour_role.labour_id    =  ppc_labour.labour_id
            INNER JOIN ppc_hr_slot ON ppc_hr_slot.labour_role_db_id = ppc_labour_role.labour_role_db_id AND
   ...
   WHERE
      ( ppc_labour_role.labour_role_db_id, ppc_labour_role.labour_role_id )
      IN
      (  SELECT 
   ...
   WHERE
      ( ppc_labour.labour_db_id, ppc_labour.labour_id )
      IN
      (  SELECT 
...
BEGIN
   ...
   WHERE
      ( ppc_publish_failure.ppc_failure_db_id, ppc_publish_failure.ppc_failure_id )
      IN
      (  SELECT 
            ppc_publish_failure.ppc_failure_db_id, 
            ppc_publish_failure.ppc_failure_id
         FROM
            ppc_wp
            INNER JOIN ppc_publish_failure ON ppc_publish_failure.ppc_wp_db_id = ppc_wp.ppc_wp_db_id AND
                                           ppc_publish_failure.ppc_wp_id = ppc_wp.ppc_wp_id
         WHERE
            ppc_wp.ppc_db_id = an_PpcDbId AND
            ppc_wp.ppc_id = an_PpcId
      );
   ...
   WHERE
      ( ppc_publish.ppc_wp_db_id, ppc_publish.ppc_wp_id )
      IN
      (  SELECT 
            ppc_wp.ppc_wp_db_id, 
            ppc_wp.ppc_wp_id
...
BEGIN
   ...
   WHERE
      ( ppc_planning_type_skill.ppc_wp_db_id, 
        ppc_planning_type_skill.ppc_wp_id, 
      ...
      (  SELECT 
         ...
         FROM
            ppc_wp
            INNER JOIN ppc_planning_type_skill ON ppc_planning_type_skill.ppc_wp_db_id = ppc_wp.ppc_wp_db_id AND
                                            ppc_planning_type_skill.ppc_wp_id = ppc_wp.ppc_wp_id
         WHERE
            ppc_wp.ppc_db_id = an_PpcDbId AND
            ppc_wp.ppc_id = an_PpcId
      );
   ...
   WHERE
      ( ppc_planning_type.ppc_wp_db_id, 
        ppc_planning_type.ppc_wp_id, 
      ...
      (  SELECT 
         ...
         FROM
            ppc_wp
            INNER JOIN ppc_planning_type ON ppc_planning_type.ppc_wp_db_id = ppc_wp.ppc_wp_db_id AND
                                            ppc_planning_type.ppc_wp_id = ppc_wp.ppc_wp_id
         WHERE
            ppc_wp.ppc_db_id = an_PpcDbId AND
            ppc_wp.ppc_id = an_PpcId
      );
...
BEGIN
   ...
   WHERE
      ( ppc_task_defn_map.ppc_task_defn_db_id, 
        ppc_task_defn_map.ppc_task_defn_id, 
        ppc_task_defn_map.ppc_task_db_id, 
        ppc_task_defn_map.ppc_task_id )
      IN
      (  SELECT 
            ppc_task_defn_map.ppc_task_defn_db_id, 
            ppc_task_defn_map.ppc_task_defn_id, 
         ...
         FROM
            ppc_wp
            INNER JOIN ppc_task_defn ON ppc_task_defn.ppc_wp_db_id = ppc_wp.ppc_wp_db_id AND
                                        ppc_task_defn.ppc_wp_id = ppc_wp.ppc_wp_id
            INNER JOIN ppc_task_defn_map ON ppc_task_defn_map.ppc_task_defn_db_id = ppc_task_defn.ppc_task_defn_db_id AND
                                            ppc_task_defn_map.ppc_task_defn_id = ppc_task_defn.ppc_task_defn_id
         WHERE
            ppc_wp.ppc_db_id = an_PpcDbId AND
            ppc_wp.ppc_id = an_PpcId
      );
   ...
   WHERE
      ( ppc_task_defn.ppc_task_defn_db_id, 
        ppc_task_defn.ppc_task_defn_id )
      IN
      (  SELECT 
            ppc_task_defn.ppc_task_defn_db_id, 
            ppc_task_defn.ppc_task_defn_id
...
BEGIN
   ...
   WHERE
      ...
      IN
      (  SELECT 
            ppc_activity.ppc_activity_db_id, 
            ppc_activity.ppc_activity_id
         FROM
            ppc_wp
            INNER JOIN ppc_activity ON ppc_activity.ppc_wp_db_id = ppc_wp.ppc_wp_db_id AND
                                       ppc_activity.ppc_wp_id = ppc_wp.ppc_wp_id
         WHERE
            ...
            ppc_activity.ppc_activity_type_cd = icn_Task
      );

   -- Delete ppc_work_area entities
   DELETE FROM ppc_work_area_crew
   WHERE
      ( ppc_work_area_crew.ppc_work_area_db_id, 
        ppc_work_area_crew.ppc_work_area_id,
        ppc_work_area_crew.ppc_crew_db_id,
        ppc_work_area_crew.ppc_crew_id )
      IN
      (  SELECT 
            ppc_work_area_crew.ppc_work_area_db_id, 
            ppc_work_area_crew.ppc_work_area_id,
         ...
         FROM
            ...
            INNER JOIN ppc_activity ON ppc_activity.ppc_wp_db_id = ppc_wp.ppc_wp_db_id AND
                                       ppc_activity.ppc_wp_id = ppc_wp.ppc_wp_id
            INNER JOIN ppc_work_area_crew ON ppc_work_area_crew.ppc_work_area_db_id = ppc_activity.ppc_activity_db_id AND
                                             ppc_work_area_crew.ppc_work_area_id = ppc_activity.ppc_activity_id
         WHERE
            ppc_wp.ppc_db_id = an_PpcDbId AND
            ppc_wp.ppc_id = an_PpcId
            AND
         ...
         FROM
            ppc_loc
            INNER JOIN ppc_crew ON ppc_crew.ppc_loc_db_id = ppc_loc.ppc_loc_db_id AND
                                   ppc_crew.ppc_loc_id = ppc_loc.ppc_loc_id
            INNER JOIN ppc_work_area_crew ON ppc_work_area_crew.ppc_crew_db_id = ppc_crew.ppc_loc_db_id AND
                                             ppc_work_area_crew.ppc_crew_id = ppc_crew.ppc_loc_id
         WHERE
   ...
   WHERE
      ( ppc_work_area_zone.ppc_work_area_zone_db_id, 
        ppc_work_area_zone.ppc_work_area_zone_id )
      IN
      (  SELECT 
            ppc_work_area_zone.ppc_work_area_zone_db_id, 
            ppc_work_area_zone.ppc_work_area_zone_id
         FROM
            ...
            INNER JOIN ppc_activity ON ppc_activity.ppc_wp_db_id = ppc_wp.ppc_wp_db_id AND
                                       ppc_activity.ppc_wp_id = ppc_wp.ppc_wp_id
            INNER JOIN ppc_work_area_zone ON ppc_work_area_zone.ppc_work_area_db_id = ppc_activity.ppc_activity_db_id AND
                                             ppc_work_area_zone.ppc_work_area_id = ppc_activity.ppc_activity_id
         WHERE
            ppc_wp.ppc_db_id = an_PpcDbId AND
            ppc_wp.ppc_id = an_PpcId
            AND
   ...
   WHERE
      ( ppc_work_area.ppc_work_area_db_id, 
        ppc_work_area.ppc_work_area_id )
      IN
      (  SELECT 
            ppc_activity.ppc_activity_db_id, 
            ppc_activity.ppc_activity_id
   ...
   WHERE
      ( ppc_phase.ppc_phase_db_id, ppc_phase.ppc_phase_id )
      IN
   ...
   WHERE
      ( ppc_phase_class.ppc_phase_class_db_id, 
        ppc_phase_class.ppc_phase_class_id )
      IN
      (  SELECT 
            ppc_phase_class.ppc_phase_class_db_id, 
            ppc_phase_class.ppc_phase_class_id
   ...
   WHERE
      ( ppc_phase.ppc_phase_db_id, 
        ppc_phase.ppc_phase_id )
      IN
      (  SELECT 
            ppc_activity.ppc_activity_db_id, 
            ppc_activity.ppc_activity_id
   ...
   WHERE
      ( ppc_milestone_cond.ppc_milestone_db_id, 
        ppc_milestone_cond.ppc_milestone_id )
      IN
      (  SELECT 
            ppc_activity.ppc_activity_db_id, 
            ppc_activity.ppc_activity_id
   ...
   WHERE
      ( ppc_milestone.ppc_milestone_db_id, 
        ppc_milestone.ppc_milestone_id )
      IN
      (  SELECT 
            ppc_activity.ppc_activity_db_id, 
            ppc_activity.ppc_activity_id
...
BEGIN
   ...
   WHERE
      ( ppc_loc_capacity.ppc_capacity_db_id, 
        ppc_loc_capacity.ppc_capacity_id )
      IN
      (  SELECT 
            ppc_loc_capacity.ppc_capacity_db_id, 
            ppc_loc_capacity.ppc_capacity_id
         FROM
            ...
            INNER JOIN ppc_loc ON ppc_loc.ppc_db_id = ppc_plan.ppc_db_id AND
                                  ppc_loc.ppc_id = ppc_plan.ppc_id
            INNER JOIN ppc_loc_capacity ON ppc_loc_capacity.ppc_loc_db_id = ppc_loc.ppc_loc_db_id AND
                                           ppc_loc_capacity.ppc_loc_id = ppc_loc.ppc_loc_id
         WHERE
            ppc_plan.ppc_db_id = an_PpcDbId AND
            ppc_plan.ppc_id = an_PpcId
      );
   ...
   WHERE
      ( ppc_crew.ppc_crew_db_id, 
        ppc_crew.ppc_crew_id )
      IN
      (  SELECT 
            ppc_crew.ppc_crew_db_id, 
            ppc_crew.ppc_crew_id
   ...
   UPDATE ppc_loc
   SET
      ppc_loc.nh_ppc_loc_db_id = NULL,
      ppc_loc.nh_ppc_loc_id = NULL
   WHERE
      ppc_loc.ppc_db_id = an_PpcDbId AND
      ppc_loc.ppc_id = an_PpcId;
...
BEGIN
   ...
   deletePpcPublish(an_PpcDbId, an_PpcId); -- 1
   deletePpcPlanningType(an_PpcDbId, an_PpcId); -- 2
   ...
   deletePpcLabour(an_PpcDbId, an_PpcId); -- 4
   deletePpcHrShiftPlan(an_PpcDbId, an_PpcId); -- 5
   deletePpcTaskDefn(an_PpcDbId, an_PpcId); -- 6
   deletePpcActivity(an_PpcDbId, an_PpcId); -- 7
   ...
   deletePpcLoc(an_PpcDbId, an_PpcId); -- 9
