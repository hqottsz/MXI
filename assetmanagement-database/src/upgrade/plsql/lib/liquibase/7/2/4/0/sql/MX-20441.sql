...
--changeSet MX-20441:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet MX-20441:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet MX-20441:3 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet MX-20441:4 stripComments:false
-- insert INVENTORY_CREATED_SUBCOMPONENTS_MISSING_DATE alert type
INSERT INTO
 utl_alert_type
 (
 ...
 SELECT 
    221, 
    'core.alert.INVENTORY_CREATED_SUBCOMPONENTS_MISSING_DATE_name', 
    'core.alert.INVENTORY_CREATED_SUBCOMPONENTS_MISSING_DATE_description', 
    'ROLE', 
    'INVENTORY', 
    'core.alert.INVENTORY_CREATED_SUBCOMPONENTS_MISSING_DATE_message', 
    1, 
    0, 
    1, 
    0 
 FROM
    dual
 WHERE
    NOT EXISTS ( SELECT 1 FROM utl_alert_type WHERE alert_type_id = 221 );