...
--changeSet MX-23036.2:1 stripComments:false
-- This view returns the latest approved task revisions for a carrier
CREATE OR REPLACE VIEW vw_maint_prgm_carrier_task
AS
--
-- TEMPORARILY RECREATING VIEW WITH THE 7.2-SP3 VERSION TO
-- HANDLE REFERENCES TO THE VIEW WHICH NO LONGER EXISTS IN
-- A BASE 7.2-SP3 SCHEMA.
--
