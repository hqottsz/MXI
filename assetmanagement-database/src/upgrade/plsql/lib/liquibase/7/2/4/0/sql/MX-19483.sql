...
--changeSet MX-19483:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet MX-19483:2 stripComments:false
-- clean up SER inventory's eqp_assmbl_bom foreign key
UPDATE inv_inv t SET t.assmbl_db_id = NULL, t.assmbl_cd = NULL, t.assmbl_bom_id = NULL, t.assmbl_pos_id = NULL WHERE t.Inv_Class_Cd = 'SER';