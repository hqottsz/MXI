...
--changeSet MX-15876:1 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.TYPE_DROP('DEADLINERECORD');
END;
/

--changeSet MX-15876:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
CREATE OR REPLACE TYPE DEADLINERECORD AS OBJECT (

   DataTypeDbId       NUMBER  ( 10, 0 ),
   DataTypeId         NUMBER  ( 10, 0 ),
   ...
   UsageRemainingQt   FLOAT   ( 22 )
);
/

--changeSet MX-15876:3 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
BEGIN
   ...
   ELSIF aDataTypeCd = 'CMON' THEN
      lExtDeadlineDt := ADD_MONTHS( aSchedDt, aDeltaQt ) + (aDeltaQt - TRUNC(aDeltaQt)) * aMultiplier;
...
--changeSet MX-15876:4 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.FUNCTION_DROP('GETFORECASTEDDRIVINGDUEDATE');
END;
/

--changeSet MX-15876:5 stripComments:false
...
--changeSet MX-15876:6 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet MX-15876:7 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
