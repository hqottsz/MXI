...
--changeSet MX-18175:1 stripComments:false
UPDATE UTL_CONFIG_PARM
   SET PARM_DESC = 'Permission to create an aircraft work package.'
 WHERE PARM_NAME = 'ACTION_CREATE_BLANK_CHECK'; 

--changeSet MX-18175:2 stripComments:false
UPDATE UTL_CONFIG_PARM
   SET PARM_DESC = 'Permission to create a work package for a fault or task. Visibility of the button depends on the context (aircraft or uninstalled component) and the status of the ACTION_CREATE_COMPONENT_WORK_ORDER and ACTION_CREATE_BLANK_CHECK permissions.'
 WHERE PARM_NAME = 'ACTION_CREATE_CHECK_FOR_FAULT_OR_TASK'; 

--changeSet MX-18175:3 stripComments:false
UPDATE UTL_CONFIG_PARM
   SET PARM_DESC = 'Permission to package and complete a task. Visibility of the button depends on the context (aircraft or uninstalled component) and the status of the  ACTION_CREATE_COMPONENT_WORK_ORDER and ACTION_CREATE_BLANK_CHECK permissions.'
 WHERE PARM_NAME = 'ACTION_PACKAGE_AND_COMPLETE_TASK'; 

--changeSet MX-18175:4 stripComments:false
UPDATE UTL_CONFIG_PARM
   SET PARM_DESC = 'Permission to create a historic work package. Visibility of the button depends on the context (aircraft or component) and the status of the ACTION_CREATE_COMPONENT_WORK_ORDER and ACTION_CREATE_BLANK_CHECK permissions.'
 WHERE PARM_NAME = 'ACTION_CREATE_HISTORIC_ROOT_TASK'; 

--changeSet MX-18175:5 stripComments:false
UPDATE UTL_CONFIG_PARM
   SET PARM_DESC = 'Permission to create a work package on a component/subassembly.'
 WHERE PARM_NAME = 'ACTION_CREATE_COMPONENT_WORK_ORDER'; 

--changeSet MX-18175:6 stripComments:false
UPDATE UTL_CONFIG_PARM
   SET PARM_DESC = 'Permission to package and complete a fault. Visibility of the button depends on the context (aircraft or uninstalled component) and the status of the ACTION_CREATE_COMPONENT_WORK_ORDER and ACTION_CREATE_BLANK_CHECK permissions.'
 WHERE PARM_NAME = 'ACTION_PACKAGE_AND_COMPLETE_FAULT';    

--changeSet MX-18175:7 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
