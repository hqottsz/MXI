...
--changeSet MX-19095:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet MX-19095:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet MX-19095:3 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
DECLARE
   P_PARM_NAME VARCHAR2(500);
   P_PARM_TYPE VARCHAR2(40);
   P_PARM_DESC VARCHAR2(4000);
   P_CONFIG_TYPE VARCHAR2(80);
   P_ALLOW_VALUE_DESC VARCHAR2(1000);
   P_DEFAULT_VALUE VARCHAR2(1000);
   P_MAND_CONFIG_BOOL NUMBER;
   P_CATEGORY VARCHAR2(4000);
   P_MODIFIED_IN VARCHAR2(4000);
   P_UTL_ID NUMBER;
   P_MIGR_PARM_NAME VARCHAR2(500);
   P_DB_TYPES UTL_MIGR_DATA_PKG.DBTYPECDLIST;
BEGIN
   P_PARM_NAME := 'ACTION_ALLOW_EDIT_CERT_INSP_REQ';
   P_PARM_TYPE := 'SECURED_RESOURCE';
   P_PARM_DESC := 'Permission to edit non-historic certification or inspection labour roles.';
   P_CONFIG_TYPE := 'USER';
   P_ALLOW_VALUE_DESC := 'TRUE/FALSE';
   P_DEFAULT_VALUE := 'FALSE';
   P_MAND_CONFIG_BOOL := 1;
   P_CATEGORY := 'Maint - Tasks';
   P_MODIFIED_IN := '7.1-SP2';
   P_UTL_ID := 0;
   P_MIGR_PARM_NAME := 'ACTION_UNCHECK_CERTIFICATION_ROLE';
   P_DB_TYPES := UTL_MIGR_DATA_PKG.DbTypeCdList('OPER');

   --ACTION_ALLOW_EDIT_CERT_INSP_REQ
   UTL_MIGR_DATA_PKG.CONFIG_PARM_INSERT(
      P_PARM_NAME => P_PARM_NAME,
      P_PARM_TYPE => P_PARM_TYPE,
      P_PARM_DESC => P_PARM_DESC,
      P_CONFIG_TYPE => P_CONFIG_TYPE,
      P_ALLOW_VALUE_DESC => P_ALLOW_VALUE_DESC,
      P_DEFAULT_VALUE => P_DEFAULT_VALUE,
      P_MAND_CONFIG_BOOL => P_MAND_CONFIG_BOOL,
      P_CATEGORY => P_CATEGORY,
      P_MODIFIED_IN => P_MODIFIED_IN,
      P_UTL_ID => P_UTL_ID,
      P_DB_TYPES => P_DB_TYPES
   );
   ...
   UTL_MIGR_DATA_PKG.CONFIG_PARM_COPY(
      ...
      P_PARM_TYPE => P_PARM_TYPE,
      P_CONFIG_TYPE => P_CONFIG_TYPE,
      P_MIGR_PARM_NAME => P_MIGR_PARM_NAME
   );
  
   P_PARM_NAME := 'ACTION_ALLOW_HIST_EDIT_CERT_INSP_REQ';
   P_PARM_DESC := 'Permission to edit historic certification or inspection labour roles.';
   P_CATEGORY := 'Maint - Historic Editing';
   ...
   -- DELETE ACTION_UNCHECK_CERTIFICATION_ROLE
   UTL_MIGR_DATA_PKG.CONFIG_PARM_DELETE(
      P_PARM_NAME => P_MIGR_PARM_NAME
   );
END;
/