...
--changeSet MX-18453:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
/* This function will return 0 if no alteration tasks for a postmod task are completed, */
/* else it will return the number of alteration tasks completed */
...
--changeSet MX-18453:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
FUNCTION getAlterationTasksCompleted (
   ...
   WHEN OTHERS THEN
      -- Unexpected error
     APPLICATION_OBJECT_PKG.SetMxiError('DEV-99999','sched_stask_pkg@@@getAlterationTasksCompleted@@@'||SQLERRM);     
     RETURN icn_Error;
   END getAlterationTasksCompleted;
/********************************************************************************
*
...
--changeSet MX-18453:3 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
