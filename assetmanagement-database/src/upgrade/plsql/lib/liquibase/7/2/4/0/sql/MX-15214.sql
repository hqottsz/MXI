...
--changeSet MX-15214:1 stripComments:false
UPDATE ref_fail_sev
SET    fail_sev_ord   = 20
WHERE  fail_sev_db_id = 0 AND
       fail_sev_cd    = 'UNKNOWN';

--changeSet MX-15214:2 stripComments:false
UPDATE ref_fail_sev
SET    fail_sev_ord   = 25
WHERE  fail_sev_db_id = 0 AND
       fail_sev_cd    = 'MINOR';

--changeSet MX-15214:3 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
