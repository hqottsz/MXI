...
--changeSet 50.0.aopr_rbl_fault_tail_ucl_mv1:1 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.MATERIALIZED_VIEW_DROP('AOPR_RBL_FAULT_TAIL_UCL_MV1');
END;
/

--changeSet 50.0.aopr_rbl_fault_tail_ucl_mv1:2 stripComments:false
