...
SELECT
  ...
  --- asset info
   ...
   --assembly sub type
   eqp_assmbl_subtype.subtype_cd                AS assembly_sub_type_code
FROM
   inv_inv
   -- aircraft
   ...
   -- assembly subtype
   LEFT JOIN eqp_assmbl_subtype ON
      inv_inv.assmbl_subtype_db_id = eqp_assmbl_subtype.assmbl_subtype_db_id AND
      inv_inv.assmbl_subtype_id    = eqp_assmbl_subtype.assmbl_subtype_id
;