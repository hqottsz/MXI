...
--changeSet MTX-394-1:1 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.SEQUENCE_DROP('PPC_ACTIVITY_ID_SEQ');
END;
/

--changeSet MTX-394-1:2 stripComments:false
DELETE FROM utl_sequence WHERE sequence_cd = 'PPC_ACTIVITY_ID_SEQ';

--changeSet MTX-394-1:3 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.SEQUENCE_DROP('PPC_CAPACITY_ID_SEQ');
END;
/

--changeSet MTX-394-1:4 stripComments:false
DELETE FROM utl_sequence WHERE sequence_cd = 'PPC_CAPACITY_ID_SEQ';

--changeSet MTX-394-1:5 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.SEQUENCE_DROP('PPC_CREW_ID_SEQ');
END;
/

--changeSet MTX-394-1:6 stripComments:false
DELETE FROM utl_sequence WHERE sequence_cd = 'PPC_CREW_ID_SEQ';

--changeSet MTX-394-1:7 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.SEQUENCE_DROP('PPC_HR_ID_SEQ');
END;
/

--changeSet MTX-394-1:8 stripComments:false
DELETE FROM utl_sequence WHERE sequence_cd = 'PPC_HR_ID_SEQ';

--changeSet MTX-394-1:9 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.SEQUENCE_DROP('PPC_HR_LIC_ID_SEQ');
END;
/

--changeSet MTX-394-1:10 stripComments:false
DELETE FROM utl_sequence WHERE sequence_cd = 'PPC_HR_LIC_ID_SEQ';

--changeSet MTX-394-1:11 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.SEQUENCE_DROP('PPC_HR_SHIFT_ID_SEQ');
END;
/

--changeSet MTX-394-1:12 stripComments:false
DELETE FROM utl_sequence WHERE sequence_cd = 'PPC_HR_SHIFT_ID_SEQ';

--changeSet MTX-394-1:13 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.SEQUENCE_DROP('PPC_HR_SLOT_ID_SEQ');
END;
/

--changeSet MTX-394-1:14 stripComments:false
DELETE FROM utl_sequence WHERE sequence_cd = 'PPC_HR_SLOT_ID_SEQ';

--changeSet MTX-394-1:15 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.SEQUENCE_DROP('PPC_ID_SEQ');
END;
/

--changeSet MTX-394-1:16 stripComments:false
DELETE FROM utl_sequence WHERE sequence_cd = 'PPC_ID_SEQ';

--changeSet MTX-394-1:17 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.SEQUENCE_DROP('PPC_LABOUR_ID_SEQ');
END;
/

--changeSet MTX-394-1:18 stripComments:false
DELETE FROM utl_sequence WHERE sequence_cd = 'PPC_LABOUR_ID_SEQ';

--changeSet MTX-394-1:19 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.SEQUENCE_DROP('PPC_LABOUR_ROLE_ID_SEQ');
END;
/

--changeSet MTX-394-1:20 stripComments:false
DELETE FROM utl_sequence WHERE sequence_cd = 'PPC_LABOUR_ROLE_ID_SEQ';

--changeSet MTX-394-1:21 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.SEQUENCE_DROP('PPC_LOC_ID_SEQ');
END;
/

--changeSet MTX-394-1:22 stripComments:false
DELETE FROM utl_sequence WHERE sequence_cd = 'PPC_LOC_ID_SEQ';

--changeSet MTX-394-1:23 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.SEQUENCE_DROP('PPC_PHASE_CLASS_ID_SEQ');
END;
/

--changeSet MTX-394-1:24 stripComments:false
DELETE FROM utl_sequence WHERE sequence_cd = 'PPC_PHASE_CLASS_ID_SEQ';

--changeSet MTX-394-1:25 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.SEQUENCE_DROP('PPC_PUBLISH_FAILURE_ID_SEQ');
END;
/

--changeSet MTX-394-1:26 stripComments:false
DELETE FROM utl_sequence WHERE sequence_cd = 'PPC_PUBLISH_FAILURE_ID_SEQ';

--changeSet MTX-394-1:27 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.SEQUENCE_DROP('PPC_TASK_DEFN_ID_SEQ');
END;
/

--changeSet MTX-394-1:28 stripComments:false
DELETE FROM utl_sequence WHERE sequence_cd = 'PPC_TASK_DEFN_ID_SEQ';

--changeSet MTX-394-1:29 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.SEQUENCE_DROP('PPC_WORK_AREA_ZONE_ID_SEQ');
END;
/

--changeSet MTX-394-1:30 stripComments:false
DELETE FROM utl_sequence WHERE sequence_cd = 'PPC_WORK_AREA_ZONE_ID_SEQ';

--changeSet MTX-394-1:31 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.SEQUENCE_DROP('PPC_WP_ID_SEQ');
END;
/

--changeSet MTX-394-1:32 stripComments:false
DELETE FROM utl_sequence WHERE sequence_cd = 'PPC_WP_ID_SEQ';

--changeSet MTX-394-1:33 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet MTX-394-1:34 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
