...
--changeSet acor_order_receipts_v1:1 stripComments:false
CREATE OR REPLACE FORCE VIEW acor_order_receipts_v1
AS 
SELECT DISTINCT
...
FROM
   ...
   LEFT JOIN (
      ...
      FROM
         ...
         WHERE
            ship_shipment.shipment_type_cd IN ( 'PURCHASE', 'REPAIR', 'RTNVEN')
            AND
            ship_shipment_line.receive_qt != 0
