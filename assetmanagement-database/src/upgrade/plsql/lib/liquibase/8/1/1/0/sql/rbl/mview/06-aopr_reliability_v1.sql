...
--changeSet 06-aopr_reliability_v1:1 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.MATERIALIZED_VIEW_DROP('AOPR_RELIABILITY_V1');
END;
/

--changeSet 06-aopr_reliability_v1:2 stripComments:false
...
SELECT
     ...
     monthly_dispatch.year_code || '-' || monthly_dispatch.month_code AS year_month,
