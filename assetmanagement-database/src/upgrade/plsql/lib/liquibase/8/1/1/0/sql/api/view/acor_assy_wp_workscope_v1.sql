...
--changeSet acor_assy_wp_workscope_v1:1 stripComments:false
CREATE OR REPLACE FORCE VIEW acor_assy_wp_workscope_v1
AS 
SELECT
...
FROM
   acor_assy_wp_v1 assy_wp
   INNER JOIN sched_stask ON
      assy_wp.sched_id = sched_stask.alt_id
