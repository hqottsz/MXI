...
--changeSet 02-opr_rbl_monthly_usage_mv:1 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.MATERIALIZED_VIEW_DROP('OPR_RBL_MONTHLY_USAGE_MV');
END;
/

--changeSet 02-opr_rbl_monthly_usage_mv:2 stripComments:false
