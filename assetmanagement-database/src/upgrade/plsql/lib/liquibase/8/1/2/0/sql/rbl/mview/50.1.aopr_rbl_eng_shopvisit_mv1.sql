...
--changeSet 50.1.aopr_rbl_eng_shopvisit_mv1:1 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.MATERIALIZED_VIEW_DROP('AOPR_RBL_ENG_SHOPVISIT_MV1');
END;
/

--changeSet 50.1.aopr_rbl_eng_shopvisit_mv1:2 stripComments:false
CREATE MATERIALIZED VIEW aopr_rbl_eng_shopvisit_mv1
BUILD DEFERRED
...
AS
   (
     ...
     FROM 
        aopr_rbl_eng_shopvisit_mon_mv1   
   )
SELECT
   m1.operator_id, 
   m1.operator_code, 
