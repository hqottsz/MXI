...
--changeSet opr_report_mview:6 stripComments:false
UPDATE
   opr_report_mview 
SET 
   refresh_frequency_code = 'DAILY'
WHERE
   mview_name in (
                     'AOPR_LOGBOOK_FAULT_MV1',
                     'ACOR_REQ_LASTDONE_NEXTDUE_V1',
                     'ACOR_BLOCK_LASTDONE_NEXTDUE_V1',
                     'ACOR_ACFT_WP_PARTS_MV1',
                     'ACOR_NON_ROUTINE_FAULT_MV1',
                     'AOPR_COMP_RMVL_MV1',
                     'ACOR_ADSB_REF_DOC_DEFN_MV1'
                 );              