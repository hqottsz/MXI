...
--changeSet aopr_assmbl_eo_compl_v1:1 stripComments:false
CREATE OR REPLACE FORCE VIEW aopr_assmbl_eo_compl_v1
AS 
WITH
rvw_act_req
AS
...
WHERE
   ...
   rvw_req_ata.logcard_form_code IN ('ENG','APU','LGEAR')
;