...
--changeSet oper-236-002:1 stripComments:false
...
FROM
   ...
   INNER JOIN aopr_2digit_ata_code_v1 ata_2digit ON
      opr_rbl_fault_fleet_summary.fleet_type       = ata_2digit.assembly_code AND
      opr_rbl_fault_fleet_summary.config_slot_code = ata_2digit.config_slot_code
ORDER BY
   fleet_type,
   config_slot_code
;