...
--changeSet MX-29017:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
PROCEDURE getStdUnitOfMeasure(
   ...
   aQtyUnitOfMeasureDbId OUT ref_qty_unit.qty_unit_db_id%TYPE,
   aQtyUnitOfMeasureCd OUT ref_qty_unit.qty_unit_cd%TYPE
);
...
--changeSet MX-29017:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
