...
--changeSet MTX-1545:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
...
--changeSet MTX-1545:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
utl_migr_schema_pkg.index_create('
	Create Index "IX_PLAN_LRPREPORTSCHED" ON "LRP_REPORT_SCHEDULE" ("PLAN_DB_ID","PLAN_ID")
');
END;
/

--changeSet MTX-1545:3 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
* Description: This procedure is used to load the LRP_PLAN_SCHEDULE table 
*              with the data for a particular plan
*
* Parameters:  an_LrpPlanDbId, an_LrpPlanId - This is the ID of the saved LRP 
*                    plan that is being loaded into the reporting table. Only 
...
--changeSet MTX-1545:4 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
*********************************************************************************/
   ...
   *********************************************************************************/
   ...
   BEGIN
      ...
      /* Use the "APPEND" hint to improve performance of the mass insert in Oracle */
      INSERT INTO lrp_report_schedule (
         /*+ APPEND */
         plan_db_id,
         plan_id,
         plan_sdesc,
