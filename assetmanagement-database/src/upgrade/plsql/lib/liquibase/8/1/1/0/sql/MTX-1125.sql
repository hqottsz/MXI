...
--changeSet MTX-1125:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet MTX-1125:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
         ...
         INSERT INTO
            UTL_MENU_ITEM(
               ...
               SELECT
                  ...
                  NULL,
                  as_MenuName,
                  ics_MenuUrlPrefix || as_Report || chr(38) || 'aView=' || as_MenuViewOutput,
                  ln_NewWindow,
                  0
                FROM
                  dual;
      ELSE
         UPDATE UTL_MENU_ITEM
            SET
                 ...
                 MENU_LINK_URL   = ics_MenuUrlPrefix || as_Report || chr(38) || 'aView=' || as_MenuViewOutput,
