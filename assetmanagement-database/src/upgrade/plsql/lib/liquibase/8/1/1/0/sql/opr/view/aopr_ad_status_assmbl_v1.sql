...
--changeSet aopr_ad_status_assmbl_v1:1 stripComments:false
CREATE OR REPLACE FORCE VIEW aopr_ad_status_assmbl_v1
AS 
SELECT
...
FROM
   ...
   INNER JOIN acor_inv_assembly_v1 assembly ON
      opr_asset_ad_status.asset_id = assembly.inventory_id
;