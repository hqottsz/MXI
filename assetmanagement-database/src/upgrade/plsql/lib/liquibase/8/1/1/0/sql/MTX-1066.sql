...
--changeSet MTX-1066:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet MTX-1066:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
BEGIN
   ...
   IF lcur_DrvTaskDeadline%FOUND THEN
      ...
      ELSE
         ...
         lf_RemainingQt := lrec_DrvTaskDeadline.sched_dead_dt - ld_StartDt;
