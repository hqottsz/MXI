...
--changeSet aopr_repair_orders_v1:1 stripComments:false
CREATE OR REPLACE FORCE VIEW aopr_repair_orders_v1
AS 
SELECT
   po_header.work_package_barcode,
   po_header.work_package_id,
   po_header.order_id,
   po_header.Priority,
...
FROM
   acor_repair_orders_v1 po_header
