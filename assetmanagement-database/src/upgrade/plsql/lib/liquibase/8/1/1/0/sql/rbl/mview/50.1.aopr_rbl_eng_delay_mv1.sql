...
--changeSet 50.1.aopr_rbl_eng_delay_mv1:1 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.MATERIALIZED_VIEW_DROP('AOPR_RBL_ENG_DELAY_MV1');
END;
/

--changeSet 50.1.aopr_rbl_eng_delay_mv1:2 stripComments:false
