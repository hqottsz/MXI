...
--changeSet OPER-2175:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
--
-- 1. Replace the package SCHED_STASK_PKG.
--
...
--changeSet OPER-2175:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet OPER-2175:3 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
--
-- 2. Drop the procedure SCHED_STASK_PKG_UPDTPARTSTOOLS.
--
BEGIN
 
utl_migr_schema_pkg.procedure_drop('SCHED_STASK_PKG_UPDTPARTSTOOLS');
