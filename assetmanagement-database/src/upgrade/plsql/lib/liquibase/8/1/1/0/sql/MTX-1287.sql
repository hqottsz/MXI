...
--changeSet MTX-1287:1 stripComments:false splitStatements:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
/********************************************************************************
* This copy of Java Uuid/guid Generator (JUG) is licensed under the
...
* 
* Files changed include the TimeBasedGenerator class.
* 
...
*********************************************************************************/
CREATE OR REPLACE AND COMPILE JAVA SOURCE NAMED Type1UUIDGenerator AS
...
--changeSet MTX-1287:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
DECLARE
