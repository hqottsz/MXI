...
--changeSet DEV-2334:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
-- migrate sched_stask_pkg to remove reference to TASK_TASK.RELATIVE_BOOL column
...
--changeSet DEV-2334:2 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
-- drop RELATIVE_BOOL and SCHED_FROM_RECEIVED_DT_BOOL columns from TASK_TASK table
BEGIN
   UTL_MIGR_SCHEMA_PKG.TABLE_COLUMN_DROP('TASK_TASK', 'RELATIVE_BOOL');
END;
/

--changeSet DEV-2334:3 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
BEGIN
   UTL_MIGR_SCHEMA_PKG.TABLE_COLUMN_DROP('TASK_TASK', 'SCHED_FROM_RECEIVED_DT_BOOL');
END;
/