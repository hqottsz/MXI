...
--changeSet MX-27997:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
-- insert configuration parameter
BEGIN
   utl_migr_data_pkg.config_parm_insert(
      'ALLOW_ON_CONDITION_REQ_IN_MANDATORY_BLOCK',
      'LOGIC',
      'This will allow on condition requirements in mandatory blocks. Enabling this feature will have a performance impact during baseline synchronization.',
      'GLOBAL',
      'TRUE/FALSE',
      'FALSE',
      1,
...
--changeSet MX-27997:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
