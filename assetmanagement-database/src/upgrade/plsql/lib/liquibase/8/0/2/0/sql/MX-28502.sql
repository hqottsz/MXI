...
--changeSet MX-28502:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
--
-- Applies changes to EVENT_PKG and PREP_DEADLINES_PKG for MX-28502
--
...
--changeSet MX-28502:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet MX-28502:3 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
*           an_SchedFromReceivedDtBool (long) - 1 if this task is scheduled from received date
