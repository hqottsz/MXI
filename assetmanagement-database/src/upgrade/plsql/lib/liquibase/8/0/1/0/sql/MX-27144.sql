...
--changeSet MX-27144:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
/********************************************************************************
* 1. Create the new function hasOverdueNsvTasks
* 2. Update the package function INV_STATUS.CalculateStatusRecord
*********************************************************************************/
/********************************************************************************
*
...
--changeSet MX-27144:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
BEGIN
   ...
   IF ( lo_NewOpStatus.cd <> 'AOG' ) THEN
      ...
      ELSIF ( HasOverdueTasks( lrec_HInvKey )
              OR 
              ( hasOverdueNsvTasks( lrec_HInvKey.db_id, lrec_HInvKey.id ) = 1 )
         ) THEN
