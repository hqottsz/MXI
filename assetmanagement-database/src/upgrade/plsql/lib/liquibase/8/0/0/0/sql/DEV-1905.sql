...
--changeSet DEV-1905:1 stripComments:true endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
/**************************************************
* Drop and create a new type INVENTORYSTATUS
***************************************************/
BEGIN
...
--changeSet DEV-1905:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
CREATE OR REPLACE TYPE INVENTORYSTATUS
 AS OBJECT (
   ...
   list_of_reasons          VARCHAR2(200)
   
);
/

--changeSet DEV-1905:3 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet DEV-1905:4 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
/********************************************************************
* Add the new column INV_OPER_CHANGE_REASON to the INV_AC_REG table
*********************************************************************/
BEGIN
   utl_migr_schema_pkg.table_column_add('
      Alter table INV_AC_REG add (
