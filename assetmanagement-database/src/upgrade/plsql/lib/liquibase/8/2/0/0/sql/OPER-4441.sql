...
--changeSet OPER-4441:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet OPER-4441:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
BEGIN
   ...
   FOR lrec_TaskDeadline IN lcur_TaskDeadlinesForReset(an_SchedDbId,an_SchedId) LOOP 
      ...
      ELSE 
         ...
         -- The task deadline is calendar based so find the deadline start quantity.
         FindDeadlineStartQt(
            lrec_TaskDeadline.task_db_id,
            lrec_TaskDeadline.task_id,
            lrec_TaskDeadline.sched_db_id,
...
--changeSet OPER-4441:3 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
