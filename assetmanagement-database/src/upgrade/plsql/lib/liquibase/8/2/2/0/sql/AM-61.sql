...
--changeSet AM-61:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
--changeSet AM-61:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
         ...
         INSERT INTO
            UTL_MENU_ITEM(
               ...
               SELECT
                  ...
                  NULL,
                  as_MenuName,
                  ics_MenuUrlPrefix || ls_ReportName || chr(38) || 'aView=' || as_MenuViewOutput || chr(38) || 'aPromptOutput=' || ls_PromptViewOutput,
                  ln_NewWindow,
                  0
                FROM
                  dual;
      ELSE
         UPDATE UTL_MENU_ITEM
            SET
                 ...
                 MENU_LINK_URL   = ics_MenuUrlPrefix || ls_ReportName || chr(38) || 'aView=' || as_MenuViewOutput|| chr(38) || 'aPromptOutput=' || ls_PromptViewOutput,
