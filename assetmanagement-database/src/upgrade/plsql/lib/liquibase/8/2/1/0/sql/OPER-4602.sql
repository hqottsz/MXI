...
--changeSet OPER-4602:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
-- declare RECORD and TABLE types for lists of Forecast and Blackout Periods
TYPE ForecastPeriod IS RECORD (
   in_StartDate DATE,
   in_EndDate   DATE,
   in_Rate       NUMBER
   );
...
TYPE ForecastPeriods IS TABLE OF ForecastPeriod;
...
--changeSet OPER-4602:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
