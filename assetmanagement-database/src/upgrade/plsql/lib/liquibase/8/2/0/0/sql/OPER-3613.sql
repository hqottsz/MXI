...
--changeSet OPER-3613:1 stripComments:false
...
values (0, 'PRNOTAVAILABLE', 0, 'PR', 0, 01, 'Part request is not available.', 'Part request is not available.', 'NOT AVAILABLE', '10', '0',  0, TO_DATE('2015-AUG-17', 'YYYY-MM-DD'), TO_DATE('2015-AUG-17', 'YYYY-MM-DD'), 100, 'MXI');