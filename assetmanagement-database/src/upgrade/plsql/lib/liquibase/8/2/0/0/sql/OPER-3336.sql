...
--changeSet OPER-3336:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
   ...
   IS
      ...
      FROM
         ...
         WHERE
            ...
            -- workpackage scheduling
            AND
            root_event.event_db_id = root_event_inv.event_db_id AND
            root_event.event_id    = root_event_inv.event_id
            AND
            evt_inv_usage.event_db_id     = root_event_inv.event_db_id  AND
            evt_inv_usage.event_id        = root_event_inv.event_id     AND
            evt_inv_usage.event_inv_id    = root_event_inv.event_inv_id AND
