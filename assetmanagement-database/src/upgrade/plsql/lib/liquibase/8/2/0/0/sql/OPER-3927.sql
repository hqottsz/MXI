...
--changeSet OPER-3927:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
PROCEDURE UpdateDeadlinesForTask (
  ...
  -- CA deadlines
   ...
   IS
      ...
      FROM
         (SELECT
            evt_inv_usage.tsn_qt sched_dead_qt, 
          ...
          FROM evt_event_rel
            INNER JOIN evt_event ON 
              ...
              evt_event.event_id = evt_event_rel.event_id AND 
              evt_event.hist_bool = 1
            INNER JOIN evt_event root_event ON       
              root_event.event_db_id = evt_event.h_event_db_id AND 
              root_event.event_id = evt_event.h_event_id  
            INNER JOIN evt_inv root_evt_inv ON   
              root_event.event_db_id = root_evt_inv.event_db_id AND
              root_event.event_id = root_evt_inv.event_id
            ...
            INNER JOIN sched_stask root_stask ON   
            ...
            INNER JOIN evt_inv_usage ON
              evt_inv_usage.event_db_id = root_evt_inv.event_db_id AND 
              evt_inv_usage.event_id = root_evt_inv.event_id AND 
              evt_inv_usage.event_inv_id = root_evt_inv.event_inv_id
