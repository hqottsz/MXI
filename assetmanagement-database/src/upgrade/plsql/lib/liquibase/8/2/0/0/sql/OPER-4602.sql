...
BEGIN
   ...
   LOOP
      FOR i IN 1 .. lNumRecs LOOP
         ...
         -- since this method takes months, we need to mutliple the year value by the number of months in a year
 	 	 -- hence the magic 12
         lForecastRec.in_StartDate := add_months(lForecastRec.in_StartDate,lYearCount * 12);
         lForecastRec.in_EndDate   := add_months(lForecastRec.in_EndDate, lYearCount  * 12);
