...
--changeSet OPER-4834-2:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
* Arguments:
*             lcur_DepTasks Table of Forecasted Tasks,
*             an_SchedDbId  Actv Task Db Id
*             an_SchedId    Actv Task Id
* Return:
*             on_Return     NUMBER - 1 is success
*
* Description: Recalculates and Updates the Calendar Deadlines for a Task
*
*
* Orig.Coder:     Stephane Levert
* Recent Coder:
* Recent Date:    Dec 1, 2015
*
*********************************************************************************/
PROCEDURE UpdateCalendarDeadlinesForTask (
...
* Arguments:
*               lcur_DepTasks Table of Forecasted Tasks
*               an_AcftDbId   Aircraft Db Id
*               an_AcftId     Aircraft Id
*               an_SchedDbId  Actv Task Db Id
*               an_SchedId    Actv Task Id
*               an_Forecast   0 or 1, whether to process forecasted task or not
*               at_GetDt      Deadline
*               at_GetQt      hash_float_type
* Return:
*               at_GetDt      hash_date_type
*               at_GetQt      hash_float_type
*               on_Return     NUMBER - 1 is success
*
* Description: Recalculates and Updates the Usage Deadlines for a Task
*
*
* Orig.Coder:     Stephane Levert
* Recent Coder:
...
FUNCTION GetForecastPeriods(
            ...
            aStartDate     DATE,
            aEndDate       DATE) RETURN ForecastPeriods;

END EVENT_PKG;
/

--changeSet OPER-4834-2:2 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
BEGIN
   ...
   IF lcur_DrvTaskDeadline%FOUND THEN
      ...
      /*Delete any existing deadlines of the REPL task*/
      DELETE
         evt_sched_dead
      WHERE
