...
SELECT
    ...
    eqp_stock_no.stock_no_cd || ' (' || eqp_stock_no.stock_no_name || ')' AS stock_number,
    eqp_stock_no.service_lvl_pct*100     AS stock_service_level
FROM
    eqp_stock_no
...
--changeSet acor_stocks_v1:2 stripComments:false
COMMENT ON TABLE acor_stocks_v1 IS 'This view contains information related to stocks.'
; 