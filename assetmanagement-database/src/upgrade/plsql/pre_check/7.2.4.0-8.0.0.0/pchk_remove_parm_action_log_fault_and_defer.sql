...
SELECT
   ...
   utl_role_parm.parm_name             AS parm_name,
...
WHERE
   utl_role_parm.parm_name = 'ACTION_LOG_FAULT_AND_DEFER' AND
   UPPER(utl_role_parm.parm_value) = 'TRUE' AND
   utl_role_parm.role_id NOT IN
   (
      SELECT 
         role_id 
      FROM 
