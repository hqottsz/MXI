...
--changeSet getLabourAverage:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
/********************************************************************************
*
* Function:      getLabourAverage
* Arguments:     aTaskDbId   - primary key of the task_task (task revision)
*                aTaskId     - primary key of the task_task (task revision)
*                aSkillDbId - primary key of the labour skill
*                aSkillCd   - primary key of the labout skill
*
* Description:   Summarize the average actural hours per person, skill for 
*                a given task revision. 
*
* Returns:        0 if no actual hours and persons assigned.            
*
* Orig.Coder:    John Tang
* Recent Coder:  Yungjae Cho
* Recent Date:   September 6, 2011
*
*********************************************************************************/
