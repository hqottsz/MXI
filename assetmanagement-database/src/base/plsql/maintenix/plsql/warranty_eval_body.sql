...
--changeSet warranty_eval_body:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
...
BEGIN
   ...
   LOOP
      ...
      IF isRepPart(ln_PartNoDbId, ln_PartNoId) = 1
	  AND
	  -- check that the part is not excluded from the warranty contract
