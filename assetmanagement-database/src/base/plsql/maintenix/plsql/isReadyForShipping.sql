...
--changeSet isReadyForShipping:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
/********************************************************************************
*
* Function:      isReadyForShipping
* Arguments:     aShipmentDbId    - shipment db id
*                aShipmentId      - shipment id
* Description:   This function loops through all the shipment lines
*                of a shipment and determines if all the part have been picked
*		 Return 1 if it is ready for shipping.  Otherwise, return 0
*
* Orig.Coder:    Elise Do
* Recent Coder:  IndunilW
