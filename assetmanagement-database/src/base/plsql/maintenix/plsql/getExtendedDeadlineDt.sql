...
--changeSet getExtendedDeadlineDt:1 stripComments:false endDelimiter:\n\s*/\s*\n|\n\s*/\s*$
/** If this code changes, ensure that ExtendDeadline.js#getExtendedDeadlineDt is updated as well. */
