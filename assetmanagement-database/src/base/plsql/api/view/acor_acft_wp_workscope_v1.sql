...
--changeSet acor_acft_wp_workscope_v1:1 stripComments:false
CREATE OR REPLACE FORCE VIEW acor_acft_wp_workscope_v1
AS
SELECT
    ...
    nh_event.event_status_cd       AS event_status_code,
    nh_event.sched_start_dt        AS schedule_start_date,
    nh_event.sched_end_dt          AS schedule_end_date,
    nh_event.actual_start_dt       AS actual_start_date,
    nh_event.event_dt              AS actual_end_date,
    ...
    eqp_assmbl_bom.assmbl_bom_cd     AS ata_chapter,
    --
