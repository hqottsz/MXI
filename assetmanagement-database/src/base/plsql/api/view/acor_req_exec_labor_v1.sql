...
--changeSet acor_req_exec_labor_v1:1 stripComments:false
CREATE OR REPLACE FORCE VIEW acor_req_exec_labor_v1
AS
SELECT
   ...
   task_labour_list.work_perf_hr         AS work_performed_duration,
