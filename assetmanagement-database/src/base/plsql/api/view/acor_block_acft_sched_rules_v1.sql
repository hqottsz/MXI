...
--changeSet acor_block_acft_sched_rules_v1:1 stripComments:false
CREATE OR REPLACE FORCE VIEW acor_block_acft_sched_rules_v1
AS
SELECT
   task_task.alt_id              AS task_id,
   acft_inv.alt_id               AS inventory_id,
