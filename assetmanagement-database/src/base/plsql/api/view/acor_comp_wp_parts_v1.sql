...
--changeSet acor_comp_wp_parts_v1:1 stripComments:false
CREATE OR REPLACE FORCE VIEW acor_comp_wp_parts_v1
AS
WITH
rvw_inv_part
AS
...
SELECT
    ...
    rmvd_inv.barcode_sdesc            AS removal_barcode,
    ...
    inst_inv.barcode_sdesc            AS installation_barcode,
