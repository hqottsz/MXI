...
--changeSet acor_mpc_cond_v1:1 stripComments:false
CREATE OR REPLACE FORCE VIEW acor_mpc_cond_v1
AS
SELECT
...
FROM
   ...
   INNER JOIN task_cond ON
      task_cond.task_db_id = task_cond.task_db_id AND
      task_cond.task_id    = task_cond.task_id
