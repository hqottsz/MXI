...
--changeSet aopr_sb_status_comp_v1:1 stripComments:false
CREATE OR REPLACE FORCE VIEW aopr_sb_status_comp_v1
AS
SELECT
...
FROM
   ...
   INNER JOIN acor_inv_tracked_v1 tracked ON
      opr_asset_sb_status.asset_Id = tracked.inventory_id;