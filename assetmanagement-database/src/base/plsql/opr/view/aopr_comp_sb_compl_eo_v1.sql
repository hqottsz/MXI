...
--changeSet aopr_comp_sb_compl_eo_v1:1 stripComments:false
CREATE OR REPLACE FORCE VIEW aopr_comp_sb_compl_eo_v1
AS
SELECT
   ...
   dep_task_class_code
FROM
   aopr_comp_sb_compl_v1 comp_sb_compl
   INNER JOIN acor_ref_docs_compl_link_v1 ref_docs_compl_link ON
      comp_sb_compl.task_id    = ref_docs_compl_link.dep_task_id
WHERE
