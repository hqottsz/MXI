...
UPDATE utl_job SET active_bool = 0 WHERE job_cd = 'MX_COMMON_DATA_ENCRYPT';
UPDATE utl_job SET active_bool = 0 WHERE job_cd = 'MX_CORE_DEACTIVATE_WARRANTY_CONTRACT';
UPDATE utl_job SET active_bool = 0 WHERE job_cd = 'MX_COMMON_PURGE_RECORDS';
...
-- Update the parm values to ensure the developer role is up to date
DELETE FROM utl_role_parm WHERE role_id = 20000;
INSERT INTO utl_role_parm (parm_name, role_id, parm_value, parm_type, utl_id)
   (SELECT
      parm_name,
      20000 AS role_id,
...
DELETE FROM utl_action_role_parm WHERE role_id = 20000;
INSERT INTO utl_action_role_parm (parm_name, role_id, parm_value, utl_id)
   (SELECT
      parm_name,
      20000 AS role_id,
